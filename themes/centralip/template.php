...
//set fav icon
	$favicon = (isset($_SESSION['theme']['favicon']['text'])) ? escape($_SESSION['theme']['favicon']['text']) : '<!--{project_path}-->/themes/centralip/favicon.ico';
...
<body onload="<?php echo $onload;?>">
						...
						if ($menu_brand) {
							...
							//define menu brand mark
								...
								if ($_SESSION['theme']['menu_brand_type']['text'] == 'image' || $_SESSION['theme']['menu_brand_type']['text'] == '') {
									$menu_brand_image = ($_SESSION['theme']['menu_brand_image']['text'] != '') ? escape($_SESSION['theme']['menu_brand_image']['text']) : PROJECT_PATH."/themes/centralip/images/logo.png";
			...
			switch ($menu_style) {
				case 'inline':
					...
					if ($_SERVER['PHP_SELF'] != PROJECT_PATH."/core/install/install.php") {
						$logo = ($_SESSION['theme']['logo']['text'] != '') ? $_SESSION['theme']['logo']['text'] : PROJECT_PATH."/themes/centralip/images/logo.png";
	...
	// default login being used
		...
		$logo = (isset($_SESSION['theme']['logo']['text'])) ? $_SESSION['theme']['logo']['text'] : PROJECT_PATH."/themes/centralip/images/logo.png";
		?>
