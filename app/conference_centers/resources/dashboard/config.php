...
$array['dashboard'][$x]['dashboard_url'] = '/app/conference_centers/conference_centers.php';
...
$y = 0;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '4d0e15fa-5fb8-4735-b8ba-0c5ee9108c4d';
