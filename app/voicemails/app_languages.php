...
$text['message-voicemail_sms_to_invalid']['en-us'] = "Invalid SMS number(s): each number must be in E.164 format (e.g. +15551234567).";
$text['message-voicemail_sms_to_invalid']['en-gb'] = "Invalid SMS number(s): each number must be in E.164 format (e.g. +15551234567).";
$text['message-voicemail_sms_to_invalid']['ar-eg'] = "أرقام SMS غير صالحة: يجب أن يكون كل رقم بتنسيق E.164 (مثال: +15551234567).";
$text['message-voicemail_sms_to_invalid']['de-at'] = "Ungültige SMS-Nummer(n): Jede Nummer muss im E.164-Format vorliegen (z.B. +15551234567).";
$text['message-voicemail_sms_to_invalid']['de-ch'] = "Ungültige SMS-Nummer(n): Jede Nummer muss im E.164-Format vorliegen (z.B. +15551234567).";
$text['message-voicemail_sms_to_invalid']['de-de'] = "Ungültige SMS-Nummer(n): Jede Nummer muss im E.164-Format vorliegen (z.B. +15551234567).";
$text['message-voicemail_sms_to_invalid']['el-gr'] = "Μη έγκυρος/οι αριθμός/οί SMS: κάθε αριθμός πρέπει να είναι σε μορφή E.164 (π.χ. +15551234567).";
$text['message-voicemail_sms_to_invalid']['es-cl'] = "Número(s) SMS no válido(s): cada número debe estar en formato E.164 (ej. +15551234567).";
$text['message-voicemail_sms_to_invalid']['es-mx'] = "Número(s) SMS no válido(s): cada número debe estar en formato E.164 (ej. +15551234567).";
$text['message-voicemail_sms_to_invalid']['fr-ca'] = "Numéro(s) SMS invalide(s) : chaque numéro doit être au format E.164 (ex. +15551234567).";
$text['message-voicemail_sms_to_invalid']['fr-fr'] = "Numéro(s) SMS invalide(s) : chaque numéro doit être au format E.164 (ex. +15551234567).";
$text['message-voicemail_sms_to_invalid']['he-il'] = "מספר/י SMS לא תקין/ים: כל מספר חייב להיות בפורמט E.164 (לדוגמה: +15551234567).";
$text['message-voicemail_sms_to_invalid']['it-it'] = "Numero/i SMS non valido/i: ogni numero deve essere nel formato E.164 (es. +15551234567).";
$text['message-voicemail_sms_to_invalid']['ka-ge'] = "SMS ნომერი/ნომრები არასწორია: თითოეული ნომერი უნდა იყოს E.164 ფორმატში (მაგ. +15551234567).";
$text['message-voicemail_sms_to_invalid']['nl-nl'] = "Ongeldig(e) SMS-nummer(s): elk nummer moet in E.164-formaat zijn (bijv. +15551234567).";
$text['message-voicemail_sms_to_invalid']['pl-pl'] = "Nieprawidłowy/e numer(y) SMS: każdy numer musi być w formacie E.164 (np. +15551234567).";
$text['message-voicemail_sms_to_invalid']['pt-br'] = "Número(s) SMS inválido(s): cada número deve estar no formato E.164 (ex. +15551234567).";
$text['message-voicemail_sms_to_invalid']['pt-pt'] = "Número(s) SMS inválido(s): cada número deve estar no formato E.164 (ex. +15551234567).";
$text['message-voicemail_sms_to_invalid']['ro-ro'] = "Număr(e) SMS invalid(e): fiecare număr trebuie să fie în format E.164 (ex. +15551234567).";
$text['message-voicemail_sms_to_invalid']['ru-ru'] = "Неверный номер(а) SMS: каждый номер должен быть в формате E.164 (например, +15551234567).";
$text['message-voicemail_sms_to_invalid']['sv-se'] = "Ogiltigt/a SMS-nummer: varje nummer måste vara i E.164-format (t.ex. +15551234567).";
$text['message-voicemail_sms_to_invalid']['uk-ua'] = "Недійсний(і) номер(и) SMS: кожен номер має бути у форматі E.164 (наприклад, +15551234567).";
$text['message-voicemail_sms_to_invalid']['tr-tr'] = "Geçersiz SMS numarası/numaraları: her numara E.164 formatında olmalıdır (örn. +15551234567).";
$text['message-voicemail_sms_to_invalid']['zh-cn'] = "无效的SMS号码：每个号码必须为E.164格式（例如：+15551234567）。";
$text['message-voicemail_sms_to_invalid']['ja-jp'] = "無効なSMS番号: 各番号はE.164形式である必要があります（例：+15551234567）。";
$text['message-voicemail_sms_to_invalid']['ko-kr'] = "잘못된 SMS 번호: 각 번호는 E.164 형식이어야 합니다 (예: +15551234567).";
