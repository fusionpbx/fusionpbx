		...
		//add or update the database
			if (empty($_POST["persistformvar"])) {
				...
				//add common array fields
					...
					$array['voicemails'][0]['greeting_id'] = !empty($greeting_id) ? $greeting_id : null;
					$array['voicemails'][0]['voicemail_alternate_greet_id'] = !empty($voicemail_alternate_greet_id) ? preg_replace('/[^0-9+]/', '', $voicemail_alternate_greet_id) : null;
