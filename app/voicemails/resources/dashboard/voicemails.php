...
//sum total and new
	...
	if (!isset($dashboard_chart_type) || $dashboard_chart_type == "icon") {
		...
		echo "		<span style=\"background-color: #03c04a; color: #ffffff; font-size: 12px; font-weight: bold; text-align: center; position: absolute; top: 23px; left: 24.5px; padding: 4px 8px; border-radius: 50%;\">".$messages['new']."</span>\n";
		echo "	</div>\n";
		echo "</span>";
	}
