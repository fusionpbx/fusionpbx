...
//get the contents of the csv file	
	...
	foreach ($csv as $key => $csv_row) {
		//set the variables
			...
			$contact_name_given = $csv_row['FirstName'];
			$contact_name_family = $csv_row['LastName'];
			...
			$device_mac_address = $csv_row['MAC'];
			$device_profile_name = $csv_row['DeviceProfile'];
			...
			$emergency_caller_id_number = $csv_row['EmCallerIdNum'];
			...
			$outbound_caller_id_number = $csv_row['CallerIdNum'];
			...
			$voicemail_password = $csv_row['PIN'];
			$voicemail_uuid = uuid();
