...
$array['dashboard'][$x]['dashboard_number_text_color'] = '#ffb320';
...
$y = 0;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = 'b3a98d15-7966-4208-b075-b2bf9bb41d7f';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'c3c37d29-b654-4024-8ee4-d752b3e4db46';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'superadmin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '5f807aa0-e1b4-4b85-9387-4de51cbdc897';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'c3c37d29-b654-4024-8ee4-d752b3e4db46';
