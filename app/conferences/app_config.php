<?php
	...
	//permission details
		...
		$apps[$x]['permissions'][$y]['groups'][] = "admin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "conference_record";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$apps[$x]['permissions'][$y]['groups'][] = "admin";
		$y++;
	...
	//schema details
		...
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_member_pin";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['search'] = 'true';
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Optional pin number to secure access to the conference.";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_moderator_pin";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['search'] = 'true';
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Optional pin number to secure access to the conference.";
		$z++;
		...
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_member_flags";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Optional conference flags. examples: mute|deaf|waste|moderator";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_moderator_flags";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Optional conference flags. examples: mute|deaf|waste|moderator";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_record";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Selct to enable conference recording";
		$z++;
		...
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "conference_pin_enabled";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Select whether to enable or disable the conference pin.";
		$z++;
