...
adminer_html_select($C,$Ue,$Y="",$Ne=true){if($Ne)return"<select name='".h($C)."'".(is_string($Ne)?' onchange="'.h($Ne).'"':"").">".optionlist($Ue,$Y)."</select>";$J="";foreach($Ue
...
<tr><th>',lang(31),'<td>',adminer_html_select("auth[driver]",$Xb,DRIVER),'<tr><th>',lang(32),'<td><input name="auth[server]" value="',h(SERVER),'" title="hostname[:port]" placeholder="localhost" autocapitalize="off">
...
',($U=="PROCEDURE"?"<td>".adminer_html_select("fields[$s][inout]",explode("|",$ud),$o["inout"]):""),'<th>';if($Sb){echo'<input name="fields[',$s,'][field]" value="',h($o["field"]),'" onchange="editingNameChange(this);',($o["field"]!=""||count($p)>1?'':' editingAddRow(this);" onkeyup="if (this.value) editingAddRow(this);'),'" maxlength="64" autocapitalize="off">';}echo'<input type="hidden" name="fields[',$s,'][orig]" value="',h($af),'">
...
';if($K["db"]==""&&$K["ns"]==""){echo
lang(188),':
',adminer_html_select("table",$Tf,$K["table"],"this.form['change-js'].value = '1'; this.form.submit();"),'<input type="hidden" name="change-js" value="">
...
<p>
',lang(90),': ',adminer_html_select("on_delete",array(-1=>"")+explode("|",$Me),$K["on_delete"]),' ',lang(89),': ',adminer_html_select("on_update",array(-1=>"")+explode("|",$Me),$K["on_update"]),doc_link(array('sql'=>"innodb-foreign-key-constraints.html",'pgsql'=>"sql-createtable.html#SQL-CREATETABLE-REFERENCES",'mssql'=>"ms174979.aspx",'oracle'=>"clauses002.htm#sthref2903",)),'<p>
<input type="submit" value="',lang(14),'">
...
<tr><th>',lang(202),'<td><input type="number" name="INTERVAL_VALUE" value="',h($K["INTERVAL_VALUE"]),'" class="size"> ',adminer_html_select("INTERVAL_FIELD",$xd,$K["INTERVAL_FIELD"]),'<tr><th>',lang(108),'<td>',adminer_html_select("STATUS",$Jg,$K["STATUS"]),'<tr><th>',lang(97),'<td><input name="EVENT_COMMENT" value="',h($K["EVENT_COMMENT"]),'" maxlength="64">
...
<form action="" method="post" id="form">
<p>',lang(172),': <input name="name" value="',h($K["name"]),'" maxlength="64" autocapitalize="off">
',($ig?lang(19).": ".adminer_html_select("language",$ig,$K["language"]):""),'<input type="submit" value="',lang(14),'">
<table cellspacing="0" class="nowrap">
