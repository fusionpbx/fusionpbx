<?php
	//application details
		...
		$apps[$x]['description']['pt-pt'] = 'Adminer (anteriormente phpMinAdmin) Ã© uma completa ferramenta de gestÃ£o de banco de dados escrito em PHP. Adminer estÃ¡ disponÃ­vel para MySQL, PostgreSQL, SQLite, MS SQL e Oracle.';
