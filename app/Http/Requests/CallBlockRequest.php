...
class CallBlockRequest extends FormRequest
{
	...
	public function rules(): array
	{
		return [
			...
			"call_block_country_code" => ['nullable','numeric','integer','min:1','min_digits:1','max_digits:3','min:1', new E164(config('freeswitch.CHECK_COUNTRY_CODE'), '*')],
			"call_block_number" => "bail|required|integer|min_digits:1|max_digits:14",
