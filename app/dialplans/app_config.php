<?php
	...
	//schema details
		...
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_hash_file";
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "varchar(32)";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Hash of whole file dialplan XML";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_hash_canonical";
		$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "varchar(32)";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Hash of canonical dialplan XML";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_enabled_original";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "boolean";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enabled state declared by the current XML file";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_context_original";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Context declared by the current XML file (may contain the \${domain_name} token)";
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_order_original";
		$apps[$x]['db'][$y]['fields'][$z]['type'] = "numeric";
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Order declared by the current XML file";
		$z++;
