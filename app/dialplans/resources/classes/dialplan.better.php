...
/*
// uncomment the below once Time Conditions has been rewritten
...
// remove the following once Time Conditions has been rewritten
*/ 
 											
										//get the dialplan context
											$sql = "select app_uuid, dialplan_context from v_dialplans ";
											$sql .= "where dialplan_uuid = :dialplan_uuid ";
											$parameters['dialplan_uuid'] = $record['uuid'];
											$database = new database;
											$row = $database->select($sql, $parameters ?? null, 'row');

										//if not a time condition dialplan
											if ($row['app_uuid'] != '4b821450-926b-175a-af93-a03c441818b1') {

												//include dialplan context
