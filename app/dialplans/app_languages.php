...
$text['message-mismatch_detected']['en-us'] = "Mismatch detected";
$text['message-mismatch_detected']['en-gb'] = "Mismatch detected";
$text['message-mismatch_detected']['ar-eg'] = "تم اكتشاف عدم تطابق";
$text['message-mismatch_detected']['de-at'] = "Abweichung erkannt";
$text['message-mismatch_detected']['de-ch'] = "Abweichung erkannt";
$text['message-mismatch_detected']['de-de'] = "Abweichung erkannt";
$text['message-mismatch_detected']['el-gr'] = "Εντοπίστηκε ασυμφωνία";
$text['message-mismatch_detected']['es-cl'] = "Se detectó una discrepancia";
$text['message-mismatch_detected']['es-mx'] = "Se detectó una discrepancia";
$text['message-mismatch_detected']['fr-ca'] = "Une incompatibilité a été détectée";
$text['message-mismatch_detected']['fr-fr'] = "Une incompatibilité a été détectée";
$text['message-mismatch_detected']['he-il'] = "זוהתה אי-התאמה";
$text['message-mismatch_detected']['it-it'] = "Rilevata una mancata corrispondenza";
$text['message-mismatch_detected']['ka-ge'] = "აღმოჩენილია შეუსაბამობა";
$text['message-mismatch_detected']['nl-nl'] = "Niet-overeenkomend gegeven gedetecteerd";
$text['message-mismatch_detected']['pl-pl'] = "Wykryto niezgodność";
$text['message-mismatch_detected']['pt-br'] = "Incompatibilidade detectada";
$text['message-mismatch_detected']['pt-pt'] = "Incompatibilidade detetada";
$text['message-mismatch_detected']['ro-ro'] = "A fost detectată o neconcordanță";
$text['message-mismatch_detected']['ru-ru'] = "Обнаружено несоответствие";
$text['message-mismatch_detected']['sv-se'] = "Avvikelse upptäcktes";
$text['message-mismatch_detected']['uk-ua'] = "Виявлено невідповідність";
$text['message-mismatch_detected']['tr-tr'] = "Uyumsuzluk algılandı";
$text['message-mismatch_detected']['zh-cn'] = "检测到不匹配";
$text['message-mismatch_detected']['ja-jp'] = "不一致が検出されました";
$text['message-mismatch_detected']['ko-kr'] = "불일치가 감지되었습니다";

$text['message-expected']['en-us'] = "Expected";
$text['message-expected']['en-gb'] = "Expected";
$text['message-expected']['ar-eg'] = "متوقع";
$text['message-expected']['de-at'] = "Erwartet";
$text['message-expected']['de-ch'] = "Erwartet";
$text['message-expected']['de-de'] = "Erwartet";
$text['message-expected']['el-gr'] = "Αναμενόμενο";
$text['message-expected']['es-cl'] = "Esperado";
$text['message-expected']['es-mx'] = "Esperado";
$text['message-expected']['fr-ca'] = "Attendu";
$text['message-expected']['fr-fr'] = "Attendu";
$text['message-expected']['he-il'] = "צפוי";
$text['message-expected']['it-it'] = "Previsto";
$text['message-expected']['ka-ge'] = "მოსალოდნელი";
$text['message-expected']['nl-nl'] = "Verwacht";
$text['message-expected']['pl-pl'] = "Oczekiwano";
$text['message-expected']['pt-br'] = "Esperado";
$text['message-expected']['pt-pt'] = "Esperado";
$text['message-expected']['ro-ro'] = "Așteptat";
$text['message-expected']['ru-ru'] = "Ожидаемое";
$text['message-expected']['sv-se'] = "Förväntat";
$text['message-expected']['uk-ua'] = "Очікуване";
$text['message-expected']['tr-tr'] = "Beklenen";
$text['message-expected']['zh-cn'] = "预期";
$text['message-expected']['ja-jp'] = "期待値";
$text['message-expected']['ko-kr'] = "예상값";

$text['message-missing_dialplan']['en-us'] = "Missing Dialplan Entry - Run Upgrade To Restore";
$text['message-missing_dialplan']['en-gb'] = "Missing Dialplan Entry - Run Upgrade To Restore";
$text['message-missing_dialplan']['ar-eg'] = "إدخال خطة الاتصال مفقود - قم بتشغيل الترقية للاستعادة";
$text['message-missing_dialplan']['de-at'] = "Fehlender Wählplan-Eintrag - Führen Sie das Upgrade aus, um ihn wiederherzustellen";
$text['message-missing_dialplan']['de-ch'] = "Fehlender Wählplan-Eintrag - Führen Sie das Upgrade aus, um ihn wiederherzustellen";
$text['message-missing_dialplan']['de-de'] = "Fehlender Wählplan-Eintrag - Führen Sie das Upgrade aus, um ihn wiederherzustellen";
$text['message-missing_dialplan']['el-gr'] = "Λείπει καταχώριση σχεδίου κλήσης - Εκτελέστε αναβάθμιση για επαναφορά";
$text['message-missing_dialplan']['es-cl'] = "Falta la entrada del plan de marcado - Ejecute la actualización para restaurarla";
$text['message-missing_dialplan']['es-mx'] = "Falta la entrada del plan de marcado - Ejecute la actualización para restaurarla";
$text['message-missing_dialplan']['fr-ca'] = "Entrée du plan de numérotation manquante - Exécutez la mise à niveau pour la restaurer";
$text['message-missing_dialplan']['fr-fr'] = "Entrée du plan de numérotation manquante - Exécutez la mise à niveau pour la restaurer";
$text['message-missing_dialplan']['he-il'] = "רשומת תוכנית חיוג חסרה - הפעל שדרוג לשחזור";
$text['message-missing_dialplan']['it-it'] = "Voce del piano di composizione mancante - Eseguire l'aggiornamento per ripristinarla";
$text['message-missing_dialplan']['ka-ge'] = "აკლია აკრეფის გეგმის ჩანაწერი - გაუშვით განახლება აღსადგენად";
$text['message-missing_dialplan']['nl-nl'] = "Ontbrekend belplan-item - Voer de upgrade uit om te herstellen";
$text['message-missing_dialplan']['pl-pl'] = "Brakujący wpis planu wybierania - Uruchom aktualizację, aby przywrócić";
$text['message-missing_dialplan']['pt-br'] = "Entrada do plano de discagem ausente - Execute a atualização para restaurar";
$text['message-missing_dialplan']['pt-pt'] = "Entrada do plano de marcação em falta - Execute a atualização para restaurar";
$text['message-missing_dialplan']['ro-ro'] = "Intrare lipsă în planul de apelare - Rulați upgrade-ul pentru a o restaura";
$text['message-missing_dialplan']['ru-ru'] = "Отсутствует запись плана набора - Запустите обновление для восстановления";
$text['message-missing_dialplan']['sv-se'] = "Saknad uppringningsplanpost - Kör uppgraderingen för att återställa";
$text['message-missing_dialplan']['uk-ua'] = "Відсутній запис плану набору - Запустіть оновлення для відновлення";
$text['message-missing_dialplan']['tr-tr'] = "Eksik çevirme planı girişi - Geri yüklemek için yükseltmeyi çalıştırın";
$text['message-missing_dialplan']['zh-cn'] = "缺少拨号计划条目 - 运行升级以恢复";
$text['message-missing_dialplan']['ja-jp'] = "ダイヤルプランエントリが見つかりません - アップグレードを実行して復元してください";
$text['message-missing_dialplan']['ko-kr'] = "다이얼 플랜 항목이 없습니다 - 복원하려면 업그레이드를 실행하세요";
