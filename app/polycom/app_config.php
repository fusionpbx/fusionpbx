<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server.domain.local/app/polycom/resources/firmware/5.9.3/";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server.domain.local/app/polycom/resources/firmware/4.0.15.1009/";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server.domain.local/app/polycom/resources/firmware/6.4.2.3008/";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server.domain.local/app/polycom/resources/firmware/5.9.5.0614/";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server.domain.local/app/polycom/resources/firmware/5.9.7.3480/";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
