...
$text['title']['ru-ru'] = "Массовые звонки";
...
$text['label-view-calls']['ru-ru'] = "Показать звонки";
...
$text['label-concurrent-limit']['ru-ru'] = "Ограничение параллельных звонков";
...
$text['label-call-broadcasts']['ru-ru'] = "Массовые звонки";
...
$text['label-call-broadcast']['ru-ru'] = "Массовый звонок";
...
$text['description-destination']['ru-ru'] = "Отправить звонок на внутренний номер, IVR, конференцию или любой другой номер.";
...
$text['description-concurrent-limit']['ru-ru'] = "Ограничение примерного количества параллельных звонков. Оставьте пустым для его отсутствия.";
...
$text['confirm-update']['ru-ru'] = "Сохранено";
