<?php
	...
	//application details
		...
		$apps[$x]['description']['pt-br'] = "a URA toca uma gravação ou uma frase pré-definida, que são apresentados ao chamador na forma de opções para escolher. Cada opção tem um destino correspondente. Os destinos podem ser ramais, correio de voz, outros URAs, grupos, ramais de fax, etc.";
