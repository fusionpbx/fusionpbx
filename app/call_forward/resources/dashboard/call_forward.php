...
//doughnut chart
	...
	echo "					ctx.fillStyle = '".($row['dashboard_text_color'] ?? $_SESSION['dashboard']['chart_text_color']['text'])."';\n";
	echo "					ctx.fillText(options.chart_text, width / 2, top + (height / 2));\n";
	echo "					ctx.save();\n";
	echo "				}\n";
	echo "			}]\n";
	echo "		}\n";
