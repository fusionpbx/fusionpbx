...
//process this code online once
	if ($domains_processed == 1) {
		...
		//define array of settings
			...
			$x++;
			$array[$x]['default_setting_uuid'] = '05bcbb47-06f6-4c81-a1c9-cdf2982d60a7';
			$array[$x]['default_setting_category'] = 'provision';
			$array[$x]['default_setting_subcategory'] = 'yealink_rport';
			$array[$x]['default_setting_name'] = 'boolean';
			$array[$x]['default_setting_value'] = '1';
			$array[$x]['default_setting_enabled'] = 'true';
			$array[$x]['default_setting_description'] = 'Send the response back to the source it came from.';
			$x++;
			$array[$x]['default_setting_uuid'] = '70894b7b-2edd-41ad-8526-060589df4e11';
			$array[$x]['default_setting_category'] = 'provision';
			$array[$x]['default_setting_subcategory'] = 'yealink_session_timer';
			$array[$x]['default_setting_name'] = 'boolean';
			$array[$x]['default_setting_value'] = '1';
			$array[$x]['default_setting_enabled'] = 'true';
			$array[$x]['default_setting_description'] = 'SIP Session Timers';
			$x++;
			$array[$x]['default_setting_uuid'] = 'aa200d6f-c048-4203-9838-8dd05fa31bd5';
			$array[$x]['default_setting_category'] = 'provision';
			$array[$x]['default_setting_subcategory'] = 'yealink_retransmission';
			$array[$x]['default_setting_name'] = 'boolean';
			$array[$x]['default_setting_value'] = '1';
			$array[$x]['default_setting_enabled'] = 'true';
			$array[$x]['default_setting_description'] = 'Retransmission';
			$x++;
