...
$text['title-providers']['nl-nl'] = "Dienstverleners";
$text['title-providers']['pl-pl'] = "";
$text['title-providers']['pt-br'] = "Provedores VoIP";
...
$text['description-providers']['fr-ca'] = "Sur cette page, vous pouvez facilement configurer l’un des fournisseurs VoIP de la liste. Lorsque vous cliquez sur Configuration, des entrées sont ajoutées à la liste de contrôle d’accès Domaines, créer une passerelle et ajouter des itinéraires sortants pour ce transporteur. Ces fournisseurs soutiennent le projet.";
$text['description-providers']['fr-fr'] = "Sur cette page, vous pouvez facilement configurer l’un des fournisseurs VoIP de la liste. Lorsque vous cliquez sur Configuration, des entrées sont ajoutées à la liste de contrôle d’accès Domaines, créer une passerelle et ajouter des itinéraires sortants pour ce transporteur. Ces fournisseurs soutiennent le projet.";
$text['description-providers']['he-il'] = "";
$text['description-providers']['it-it'] = "";
$text['description-providers']['nl-nl'] = "Vanuit deze pagina kan makkelijk een van de VoIP Dienstverleners uit de lijst ingesteld worden. wanneer setup gekozen wordt zullen regels worden opgenomen in de Domein ACL, een gateway worden aangemaakt en uitgaande routes voor de Dienstverlener. Deze dienstverleners ondersteunen het project.";
$text['description-providers']['pl-pl'] = "";
$text['description-providers']['pt-br'] = "A partir desta página você pode facilmente configurar os provedores VoIP da lista. Quando você clicar em configurar, serão adicionados entradas na lista de controle de acesso de Domínios (ACL), o tronco e as rotas de saída para o provedor. Estes provedores apoiam o projeto.";
...
$text['label-region_skyetel']['fr-ca'] = "Fournissant des services aux États-Unis et au Canada";
$text['label-region_skyetel']['fr-fr'] = "Fournissant des services aux États-Unis et au Canada";
$text['label-region_skyetel']['he-il'] = "";
$text['label-region_skyetel']['it-it'] = "";
$text['label-region_skyetel']['nl-nl'] = "Dienstvelening in de USA en Canada";
$text['label-region_skyetel']['pl-pl'] = "";
$text['label-region_skyetel']['pt-br'] = "Oferecendo serviços para os EUA e Canadá";
...
$text['label-about_skyetel']['fr-ca'] = "Basé à Pacific Northwest, Skyetel offre une triple redondance, une interface utilisateur magnifique et des prix agressifs. Skyetel a été récompensé à plusieurs reprises pour son engagement en matière de service client et dispose d'une équipe d'assistance à plein temps qui peut vous aider à mettre rapidement vos systèmes en service.";
$text['label-about_skyetel']['fr-fr'] = "Basé à Pacific Northwest, Skyetel offre une triple redondance, une interface utilisateur magnifique et des prix agressifs. Skyetel a été récompensé à plusieurs reprises pour son engagement en matière de service client et dispose d'une équipe d'assistance à plein temps qui peut vous aider à mettre rapidement vos systèmes en service.";
$text['label-about_skyetel']['he-il'] = "";
$text['label-about_skyetel']['it-it'] = "";
$text['label-about_skyetel']['nl-nl'] = "Gebaseerd in pacific Northwest, Skyetel geeft 3-voudige backup, een mooie UI en een scherpe prijs. Skeytel heeft meerdere prijzen gewonnen voor klant dienstverleneing en heeft een full-time service team die kan helpen om systemen snel op te zetten.";
$text['label-about_skyetel']['pl-pl'] = "";
$text['label-about_skyetel']['pt-br'] = "Baseado no nordeste do Pacífico, Skyetel oferece redundância tripla, uma linda inteface, e preços agressivos. A Skyetel recebeu muitos prêmios pelo seu comprometimento com os serviços prestados e mantém um time de suporte para colocar seus sistemas funcionando rapidamente.";
...
$text['label-features_skyetel']['fr-ca'] = "Origination, terminaison, présence locale, prise en charge du numéroteur, surveillance de la disponibilité et de la qualité de service, E911, CNAM, API reposante";
$text['label-features_skyetel']['fr-fr'] = "Origination, terminaison, présence locale, prise en charge du numéroteur, surveillance de la disponibilité et de la qualité de service, E911, CNAM, API reposante";
$text['label-features_skyetel']['he-il'] = "";
$text['label-features_skyetel']['it-it'] = "";
$text['label-features_skyetel']['nl-nl'] = "Bron, Aansluiting, Locale aanwezigheid, Bel dienstverlening, Uptime enQOS beheer. E911, CNAM, en Restful API";
$text['label-features_skyetel']['pl-pl'] = "";
$text['label-features_skyetel']['pt-br'] = "Originando, Terminando, Presença local, Suporte à discagem, Disponibilidade and monitoramento de Qualidade de Serviço, E911, CNAM, Restful API.";
...
$text['label-region_voicetel']['fr-ca'] = "Fournissant des services aux États-Unis et au Canada";
$text['label-region_voicetel']['fr-fr'] = "Fournissant des services aux États-Unis et au Canada";
$text['label-region_voicetel']['he-il'] = "";
$text['label-region_voicetel']['it-it'] = "";
$text['label-region_voicetel']['nl-nl'] = "Dienstverlening in de USA en Canada.";
$text['label-region_voicetel']['pl-pl'] = "";
$text['label-region_voicetel']['pt-br'] = "Oferecendo serviços para os EUA e Canadá";
...
$text['label-features_voicetel']['fr-ca'] = "Origination, Terminaison, Envoyer et recevoir des SMS depuis votre ordinateur, tablette ou appareil mobile. Automatisez ou intégrez éventuellement la transmission SMS via l'utilisation de notre API RESTful.";
$text['label-features_voicetel']['fr-fr'] = "Origination, Terminaison, Envoyer et recevoir des SMS depuis votre ordinateur, tablette ou appareil mobile. Automatisez ou intégrez éventuellement la transmission SMS via l'utilisation de notre API RESTful.";
$text['label-features_voicetel']['he-il'] = "";
$text['label-features_voicetel']['it-it'] = "";
$text['label-features_voicetel']['nl-nl'] = "Bron, Aansluiting , Zend en ontvang SMS meldingen via de computer, tabler of mobiele telefoon. Optioneel automatiseer / embed de SMS verzending via de RESTful API.";
$text['label-features_voicetel']['pl-pl'] = "";
$text['label-features_voicetel']['pt-br'] = "Originação, Terminação, envio e recebimento de SMS do seu computador, tablet, ou dispositivo móvel. Opcionalmente automatize ou integre a transmissão de SMS com nossa API RESTful.";
