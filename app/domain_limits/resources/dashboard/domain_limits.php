...
//domain limits
	if (!empty($_SESSION['limit']) && sizeof($_SESSION['limit']) > 0) {
		...
		//determine chart data
			...
			echo "	<div style='display: flex; flex-wrap: wrap; justify-content: center; padding-bottom: 13px; background-color: ".$dashboard_number_background_color.";' ".($row['dashboard_details_state'] == "disabled" ?: "onclick=\"$('#hud_domain_limits_details').slideToggle('fast');\"").">\n";
