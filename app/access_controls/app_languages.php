...
$text['label-node_cidr']['zh-cn'] = "IP地址范围";
...
$text['label-access_control_description']['en-us'] = "描述";
...
$text['description-node_description']['zh-cn'] = "输入描述。";
...
$text['description-node_cidr']['zh-cn'] = "输入IP地址范围 例:192.168.1.0/24。";
...
$text['description-access_control_description']['zh-cn'] = "输入名称。";
...
$text['description-access_control']['zh-cn'] = "访问控制列表可以允许或拒绝IP地址范围。";
