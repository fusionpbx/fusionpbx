...
$text['description-register_proxy']['de-ch'] = "Geben Sie den Proxy für die Registrierung hier an."; //copied from de-de
...
$text['description-register_proxy']['es-mx'] = "Ingrese el proxy de registro aquí"; //copied from es-cl
$text['description-register_proxy']['fr-ca'] = "Insérer ici le proxy d'enregistrement."; //copied from fr-fr
...
$text['description-register_proxy']['ro-ro'] = "Introduceți proxy- registru de aici.";
...
$text['description-proxy']['de-ch'] = "Geben Sie die Domäne oder die IP Adresse des Proxies an."; //copied from de-de
...
$text['description-proxy']['es-mx'] = "Ingrese el dominio o dirección IP del proxy."; //copied from es-cl
$text['description-proxy']['fr-ca'] = "Le domain ou l'adresse IP du Proxy."; //copied from fr-fr
...
$text['description-proxy']['ro-ro'] = "Introduceți adresa domeniului sau IP-ul proxy.";
...
$text['description-outbound_proxy']['es-mx'] = "Ingrese un proxy de salida aquí"; //copied from es-cl
$text['description-outbound_proxy']['fr-ca'] = "Entrez ici le proxy sortant."; //copied from fr-fr
...
$text['description-outbound_proxy']['ro-ro'] = "Introdu o proxy de ieșire de aici.";
