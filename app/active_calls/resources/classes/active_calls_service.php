...
class active_calls_service extends service implements websocket_service_interface {
	 ...
	 * This check is slower then the event_exists function. Whenever possible, it is recommended to use that function
	 * instead.
	 *
	...
	/**
	 * Queries the database to return a single domain uuid for the given name. If more then one match is possible use
	 * the get_domain_names function.
	 *
