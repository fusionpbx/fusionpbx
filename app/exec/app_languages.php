...
$text['label-execute']['pt-br'] = "Executar Comando";
...
$text['description-switch']['pt-br'] = "FreeSwitch CLI. Para verificar a lista de comandos válidos utilize: 'help'";
...
$text['description-shell']['pt-br'] = "Execute comandos do sistema.";
...
$text['description-php']['pt-br'] = "Execute comandos do PHP. Veja: <a href='http://php.net/manual/' target='_blank'>Manual PHP</a>"; //copied from pt-pt
...
$text['description-execute']['pt-br'] = "Oferece uma maneira conveniente para executar comandos do sistema, PHP e FreeSwitch ";
...
$text['description-databases']['pt-br'] = "Escolha o banco de dados para utilizar.";
...
$text['button-select_database']['pt-br'] = "Selecionar banco de dados";
