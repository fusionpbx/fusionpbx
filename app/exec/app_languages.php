...
*/
	...
	$text['label-execute']['fr'] = 'Executer la Commande';
	...
	$text['description-execute']['fr'] = 'Fournir un moyen pour executer des commandes système, PHP et freeswitch. ';

	$text['label-shell']['en-us'] = 'Shell command';
	$text['label-shell']['pt-pt'] = '';
	$text['label-shell']['fr'] = 'Comamnde Shell';

	$text['description-shell']['en-us'] = 'System commands.';
	$text['description-shell']['pt-pt'] = '';
	$text['description-shell']['fr'] = 'Commande Système';

	$text['label-php']['en-us'] = 'PHP command';
	$text['label-php']['pt-pt'] = '';
	$text['label-php']['fr'] = 'Commande PHP';
	...
	$text['description-php']['fr'] = "Utiliser le lien suivant comme référence pour le PHP: <a href='http://php.net/manual/fr/index.php' target='_blank'>Manuel PHP";

	$text['label-switch']['en-us'] = 'Switch Command';
	$text['label-switch']['pt-pt'] = '';
	$text['label-switch']['fr'] = 'Commande CLI Freeswitch';

	$text['description-switch']['en-us'] = 'For a list of the valid commands use: help';
	$text['description-switch']['pt-pt'] = '';
	$text['description-switch']['fr'] = 'Pour la liste des commandes valides, utiliser : help';

	$text['button-execute']['en-us'] = 'Execute';
	$text['button-execute']['pt-pt'] = '';
	$text['button-execute']['fr'] = 'Executer';
