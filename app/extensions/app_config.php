...
";
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "d8c9b0a1-7e6f-4a5b-8c9d-0e1f2a3b4c5d";
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "8f6b2c1a-3d4e-4a5f-9b7c-1e2d3f4a5b6c";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "extension";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "required_fields";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "effective_caller_id_name";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "List of extension fields that are required.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "4e79d5f3-4e5f-4700-8dc6-17c520020da1";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "extension";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "required_fields";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "List of extension fields that are required.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "acc9b109-0c89-47c4-8a2a-fa9794b3c8d0";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "extension";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "required_fields";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "outbound_caller_id_name";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "List of extension fields that are required.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "7dc20509-fbe8-4cb8-9d2c-4b83d1bcaad7";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "extension";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "required_fields";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "outbound_caller_id_number";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "List of extension fields that are required.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "c4d5e6f7-a8b9-4c0d-9e1f-2a3b4c5d6e7f";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "extension";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "required_fields";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "emergency_caller_id_name";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "List of extension fields that are required.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "ce316460-f5d8-48b4-8919-4158987028c1";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "extension";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "required_fields";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "emergency_caller_id_number";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "List of extension fields that are required.";
		$y++;
