...
--load config
        function load_config()
                ...
                elseif (database.system.type == 'mysql') then
                        --create the system_dsn array
                        --mariadb://Server=172.26.52.15; Database=coolpbx; Uid=coolpbx; Pwd=c4rl0s3l4rt1st4"
                        table.insert(system_dsn, [[mariadb://]]);
                        if (database.system.host) then
                                table.insert(system_dsn, [[Server=]] .. database.system.host .. [[;]]);
                        end
                        if (database.system.hostaddr) then
                                table.insert(system_dsn, [[Server=]] .. database.system.hostaddr .. [[;]]);
                        end
                        table.insert(system_dsn, [[Port=]] .. database.system.port .. [[;]]);
                        table.insert(system_dsn, [[Database=]] .. database.system.name .. [[;]]);
                        table.insert(system_dsn, [[Uid=]] .. database.system.username .. [[;]]);
                        table.insert(system_dsn, [[Pwd=]] .. database.system.password .. [[]]);
                ...
                elseif (database.switch.type == 'mysql') then
                        --create the system_dsn array
                        --mariadb://Server=172.26.52.15; Database=coolpbx; Uid=coolpbx; Pwd=c4rl0s3l4rt1st4"
                        table.insert(switch_dsn, [[mariadb://]]);
                        if (database.switch.host) then
                                table.insert(switch_dsn, [[Server=]] .. database.switch.host .. [[;]]);
                        end
                        if (database.switch.hostaddr) then
                                table.insert(switch_dsn, [[Server=]] .. database.switch.hostaddr .. [[;]]);
                        end
                        table.insert(switch_dsn, [[Port=]] .. database.switch.port .. [[;]]);
                        table.insert(switch_dsn, [[Database=]] .. database.switch.name .. [[;]]);
                        table.insert(switch_dsn, [[Uid=]] .. database.switch.username .. [[;]]);
                        table.insert(switch_dsn, [[Pwd=]] .. database.switch.password .. [[]]);
