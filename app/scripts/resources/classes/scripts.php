		...
		public function write_config() {
			if (is_array($_SESSION['switch']['scripts'])) {
				...
				//make the config.lua
					...
					$tmp .= "--set defaults\n";
					$tmp .= "	expire = {}\n";
					$tmp .= "	expire.default = \"".(isset($_SESSION['xml_handler']['cache_default_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_default_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "	expire.directory = \"".(isset($_SESSION['xml_handler']['cache_directory_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_directory_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "	expire.dialplan = \"".(isset($_SESSION['xml_handler']['cache_dialplan_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_dialplan_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "	expire.languages = \"".(isset($_SESSION['xml_handler']['cache_languages_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_languages_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "	expire.sofia = \"".(isset($_SESSION['xml_handler']['cache_sofia_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_sofia_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "	expire.acl = \"".(isset($_SESSION['xml_handler']['cache_acl_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_acl_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "	expire.ivr = \"".(isset($_SESSION['xml_handler']['cache_ivr_expire_time']['numeric'])?$_SESSION['xml_handler']['cache_ivr_expire_time']['numeric']:3600)."\";\n";
					$tmp .= "\n";
					$tmp .= "--set xml_handler\n";
					$tmp .= "	xml_handler = {}\n";
					$tmp .= "	xml_handler.fs_path = ".(isset($_SESSION['xml_handler']['fs_path']['boolean'])?$_SESSION['xml_handler']['fs_path']['boolean']:'false').";\n";
					$tmp .= "	xml_handler.reg_as_number_alias = ".(isset($_SESSION['xml_handler']['reg_as_number_alias']['boolean'])?$_SESSION['xml_handler']['reg_as_number_alias']['boolean']:'false').";\n";
					$tmp .= "	xml_handler.number_as_presence_id = ".(isset($_SESSION['xml_handler']['number_as_presence_id']['boolean'])?$_SESSION['xml_handler']['number_as_presence_id']['boolean']:'true').";\n";
					$tmp .= "\n";
					$tmp .= "--set settings\n";
					$tmp .= "	settings = {}\n";
