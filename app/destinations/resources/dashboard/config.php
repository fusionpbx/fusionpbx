...
$y = 0;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '7d0066d2-d86c-4684-83ea-bc0a6eb27184';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'a294b771-a125-4d36-b51a-973540346fad';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'superadmin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = 'bf9a472a-9fb1-4c75-8134-1140b529a6b0';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'a294b771-a125-4d36-b51a-973540346fad';
