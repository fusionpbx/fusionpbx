...
class destinations {
	...
	/**
	 * Convert destination number to a regular expression using the provided array.
	 *
	 * @param array $array An array containing destination information.
	 *
	 * @return string A regular expression representing the destinations.
	 */
	...
	/**
	 * Retrieves destinations from various app_config.php files.
	 *
	 * @return array|null The retrieved destinations, or null if none found.
	 */
	...
	/**
	 * Creates a single destination select list.
	 *
	 * @param string $destination_type  The type of the destination - can be ivr, dialplan, call_center_contact or bridge.
	 * @param string $destination_name  The name of the destination.
	 * @param string $destination_value The value to be selected in the dropdown.
	 *
	 * @return string The HTML for the select list, or an empty string if no destinations are found.
	 */
	...
	/**
	 * Retrieves destinations from various app_config.php files based on the provided destination type.
	 *
	 * @param string $destination_type The type of destination to retrieve - can be ivr, dialplan, call_center_contact or bridge.
	 *
	 * @return array|null The formatted destinations as an array, or null if none found.
	 */
	...
	/**
	 * Retrieves destinations based on a given type.
	 *
	 * @param string $destination_type The type of destination to retrieve - can be ivr, dialplan, call_center_contact or bridge.
	 *
	 * @return array|null The retrieved destinations, or null if none found.
	...
	/**
	 * Validates a given destination against the existing destinations.
	 *
	 * @param string $destination The destination to validate.
	 * @param string $type        The type of destinations (e.g. 'dialplan').
	 *
	 * @return bool True if the destination is valid, false otherwise.
	 */
	...
	/**
	 * Retrieves a summary of destinations, including total calls, answered calls, unique callers, total seconds,
	 * and destination description.
	 *
	 * @return array|null The retrieved destination summary data, or null if none found.
	 */
	 ...
	 *
	 * @param string $word The word to convert to its singular form.
	 *
