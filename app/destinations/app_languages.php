...
$text['option-caller_id_number_startswith']['de-de'] = "Anruferkennung (Nummer) (Beginnt mit)";
$text['option-caller_id_number_startswith']['el-gr'] = "Αριθμός αναγνώρισης καλούντος (Ξεκινάει με)";
$text['option-caller_id_number_startswith']['es-cl'] = "Número de Caller ID (Comienza con)";
$text['option-caller_id_number_startswith']['es-mx'] = "Número de Caller ID (Comienza con)";
$text['option-caller_id_number_startswith']['fr-ca'] = "Numéro d'identification de l'appelant. (Commence avec)";
$text['option-caller_id_number_startswith']['fr-fr'] = "Numéro d'identification de l'appelant. (Commence avec)";
$text['option-caller_id_number_startswith']['he-il'] = "(מתחיל עם) מספר זיהוי מתקשר";
$text['option-caller_id_number_startswith']['it-it'] = "ID Numero Chiamante (Inizia con)";
$text['option-caller_id_number_startswith']['nl-nl'] = "CID Nummer (Begint met)";
$text['option-caller_id_number_startswith']['pl-pl'] = "Prezentacja numeru dzwoniącego (Zaczynać z)";
$text['option-caller_id_number_startswith']['pt-br'] = "Número do discador (Começa com)";
$text['option-caller_id_number_startswith']['pt-pt'] = "Número do Chamador (Começa com)";
$text['option-caller_id_number_startswith']['ro-ro'] = "Numărul de identificare a apelantului (Incepe cu)";
$text['option-caller_id_number_startswith']['ru-ru'] = "Идентификационный номер (Caller ID) вызывающего абонента (Начинается с)";
$text['option-caller_id_number_startswith']['sv-se'] = "Caller ID Nummer (Börjar med)";
$text['option-caller_id_number_startswith']['uk-ua'] = "Caller ID Номер (Починається з)";
$text['option-caller_id_number_startswith']['tr-tr'] = "Arayanın Kimlik Numarası (İle başlar)";
$text['option-caller_id_number_startswith']['zh-cn'] = "来电显示号码 （以。。开始）";
$text['option-caller_id_number_startswith']['ja-jp'] = "発信者番号 (始まり)";
$text['option-caller_id_number_startswith']['ko-kr'] = "발신자 ID 번호 (다음으로 시작)";
