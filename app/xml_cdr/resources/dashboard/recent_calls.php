...
//recent calls
	...
	if (!isset($dashboard_chart_type) || $dashboard_chart_type == "icon") {
		...
		echo "		<span style=\"background-color: #417ed3; color: #ffffff; font-size: 12px; font-weight: bold; text-align: center; position: absolute; top: 23px; left: 24.5px; padding: 4px 8px; border-radius: 50%;\">".$num_rows."</span>\n";
		echo "	</div>\n";
		echo "</div>";
	}
