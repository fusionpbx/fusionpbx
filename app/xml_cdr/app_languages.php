...
$text['description_search']['zh-cn'] = "<u>Note</u>: Destination and Caller ID (CID) 姓名领域支持将<i>asterisk</i> ('*”)用作野心。";
$text['description_search']['ja-jp'] = "<u>Note</u>: 宛先と発信者 ID (CID) 名前フィールドは、ワイルドカード文字として <i>asterisk</i> ('*') の使用をサポートします。";
$text['description_search']['ko-kr'] = "<u>Note</u>: 목적지 및 통화 ID (CID) Name 필드는 와일드카드 캐릭터로 <i>asterisk</i> ('*')의 사용을 지원합니다.";
