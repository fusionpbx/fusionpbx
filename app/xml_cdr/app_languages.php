<?php
	...
	$text['title']['fr'] = 'Historique détaillé des appels';
	...
	$text['description']['fr'] = "Ici se trouve l'historique des tous les appels passés sur cette plateforme. En Anglais: Call Detail Records (CDR).";
	...
	$text['description-2']['fr'] = "Les informations contiennent la source, la destination, la durée et pleins d'autres informations utiles.";
	...
	$text['description-3']['fr'] = "Utiliser les filtres pour afficher les appels désirés. ";
	...
	$text['description-4']['fr'] = "Ensuite visualisez les informations dans la liste ci-dessous, ou téléchargez les sous forme d'un fichier CSV.";
	...
	$text['description-5']['fr'] = "Une vue détaillée de l'appel et toutes les informations en relation.";
	...
	$text['description-6']['fr'] = "L'information contient le nom et le numéro d'appelant, données du canal, ";
	...
	$text['label-call-flow']['fr'] = "Flux d'appel: Attibuts";
	...
	$text['label-call-flow-2']['fr'] = "Flux d'appel: Extension: Attibuts";
	...
	$text['label-call-statistics']['fr'] = "Statistiques sur l'historique des appels";
