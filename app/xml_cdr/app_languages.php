...
$text['label-call_flow_summary']['de-at'] = "Zusammenfassung des Anrufverlaufs"; //copied from de-de
$text['label-call_flow_summary']['de-ch'] = "Zusammenfassung des Anrufverlaufs"; //copied from de-de
...
$text['label-call_flow_summary']['es-mx'] = "Resumen del flujo de llamadas"; //copied from es-cl
$text['label-call_flow_summary']['fr-ca'] = "Résumé du flux d'appels"; //copied from fr-fr
...
$text['label-call_flow_summary']['pt-br'] = "Resumo do Fluxo de Chamadas"; //copied from pt-pt
...
$text['description-details']['de-at'] = "Eine detaillierte Ansicht des Anrufes mit allen zugehörigen Informationen. Die Information beinhaltet Anruferkennung (Name, Nummer) und Kanal-Daten. Anruf Variablen, Ruf-Ablauf, Zeit Information und andere nützliche Anruf Details"; //copied from de-de
$text['description-details']['de-ch'] = "Eine detaillierte Ansicht des Anrufes mit allen zugehörigen Informationen. Die Information beinhaltet Anruferkennung (Name, Nummer) und Kanal-Daten. Anruf Variablen, Ruf-Ablauf, Zeit Information und andere nützliche Anruf Details"; //copied from de-de
...
$text['description-details']['es-mx'] = "Una vista detallada de la información de la llamada. La información contiene el nombre y número del caller id, datos del canal, variables de llamada, flujo, información temporal y otros detalles útiles."; //copied from es-cl
$text['description-details']['fr-ca'] = "Une vue détaillée de l'appel et toutes les informations en relation. L'information contient le nom et le numéro d'appelant, données du canal, les variables de l'appel, le chemin, les compteurs et d'autres détails."; //copied from fr-fr
