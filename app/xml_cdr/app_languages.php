...
$text['label-callback']['en-gb'] = "Callback";
$text['label-callback']['ar-eg'] = "أتصل مرة أخرى";
$text['label-callback']['de-at'] = "Rückruf";
$text['label-callback']['de-ch'] = "Rückruf";
$text['label-callback']['de-de'] = "Rückruf";
$text['label-callback']['el-gr'] = "Επανάκληση";
$text['label-callback']['es-cl'] = "Llamar de vuelta";
$text['label-callback']['es-mx'] = "Llamar de vuelta";
$text['label-callback']['fr-ca'] = "Rappel";
$text['label-callback']['fr-fr'] = "Rappel";
$text['label-callback']['he-il'] = "התקשרות חוזרת";
$text['label-callback']['it-it'] = "Richiamare";
$text['label-callback']['nl-nl'] = "Terugbellen";
$text['label-callback']['pl-pl'] = "Oddzwonienie";
$text['label-callback']['pt-br'] = "Ligar de volta";
$text['label-callback']['pt-pt'] = "Ligar de volta";
$text['label-callback']['ro-ro'] = "Sună din nou";
$text['label-callback']['ru-ru'] = "Перезвонить";
$text['label-callback']['sv-se'] = "Återuppringning";
$text['label-callback']['uk-ua'] = "Зворотний дзвінок";
$text['label-callback']['tr-tr'] = "Geri çağırmak";
$text['label-callback']['zh-cn'] = "打回来";
$text['label-callback']['ja-jp'] = "折り返し電話";
$text['label-callback']['ko-kr'] = "콜백";
