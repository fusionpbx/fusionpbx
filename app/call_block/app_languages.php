...
$text['label-edit-note']['ru-ru'] = "Блокировать звонки от номера. Отредактируйте имя и включено/выключено ниже.";
...
$text['label-add-note']['ru-ru'] = "Блокирование звонков от номера. Выберите номер из списка выше либо введить номер, имя и включить ниже.";
