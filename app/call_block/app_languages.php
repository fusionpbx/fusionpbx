...
$text['prompt-block_recent_name']['ru-ru'] = "Блокировать недавний звонок. Отредактируйте название, если необходимо...";
...
$text['label-provide-enabled']['ru-ru'] = "Пожалуйста, введите: Активировать";
...
$text['label-edit-note']['ru-ru'] = "Блокировать звонки от номера. Отредактируйте имя и активно/отключено ниже.";
...
$text['label-edit-add-recent']['ru-ru'] = "Недавние звонки";
...
$text['label-date-added']['ru-ru'] = "Дата добавлена";
...
$text['label-add-note']['ru-ru'] = "Блокирование звонков от номера. Выберите номер из списка выше либо введить номер, имя и активируйте ниже.";
...
$text['description-number']['ru-ru'] = "Введите точний номер.";
...
$text['description-enable']['ru-ru'] = "Выберите 'Да', чтобы блокировать звонки с данного номера.";
...
$text['description-call-block']['ru-ru'] = "Список номеров, с которых блокируются звонки.";
...
$text['description-action']['ru-ru'] = "Установите действие для звонков с данного номера.";
