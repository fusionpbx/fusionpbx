<?php
	...
	//permission details
		...
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "171ae356-8752-4288-8dfb-b25928221d94";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "system_view_hdd";
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "f0ed4447-c0d4-464d-b235-09be42e391a7";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "system_view_ram";
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "09593926-42fa-47e9-ab89-fc2901735bc4";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$y++;
		...
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "14a151f1-6e36-450d-bc0d-75000facdb45";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "system_view_backup";
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "a81a5468-7d28-4648-9212-bdecb5263eeb";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$y++;
		$apps[$x]['permissions'][$y]['name'] = "software_view";
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "29e68f01-91b8-49b6-b953-afc057369398";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$y++;
		...
		$apps[$x]['permissions'][$y]['menu']['uuid'] = "55fbefcb-8c11-4c68-9331-0b3cf47bca4a";
		$apps[$x]['permissions'][$y]['groups'][] = "superadmin";
		$y++;
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Network interface used to show traffic on dashboard";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "60c826be-5974-4e8e-b70f-d532b97a2b08";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "system";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "dashboard_network_usage_chart_main_color";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "#02bf4a";
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "e553208d-b5ae-4cd6-8b9b-0d2b98f0feab";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "system";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "dashboard_network_usage_chart_main_color";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "#ff9933";
