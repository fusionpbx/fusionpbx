...
$text['title-feature_report']['de-de'] = "Funktionscodes Bericht";
$text['title-feature_report']['el-gr'] = "Αναφορά Κωδικών Λειτουργιών";
$text['title-feature_report']['es-cl'] = "Informe de Códigos de Funciones";
$text['title-feature_report']['es-mx'] = "Informe de Códigos de Funciones";
$text['title-feature_report']['fr-ca'] = "Rapport des Codes de Fonctionnalités";
$text['title-feature_report']['fr-fr'] = "Rapport des Codes de Fonctionnalités";
$text['title-feature_report']['he-il'] = "דוח קודי תכונות";
$text['title-feature_report']['it-it'] = "Rapporto Codici Funzione";
$text['title-feature_report']['nl-nl'] = "Functiecodes Rapport";
$text['title-feature_report']['pl-pl'] = "Raport Kodów Funkcji";
$text['title-feature_report']['pt-br'] = "Relatório de Códigos de Recursos";
$text['title-feature_report']['pt-pt'] = "Relatório de Códigos de Funcionalidades";
$text['title-feature_report']['ro-ro'] = "Raport Coduri de Funcții";
$text['title-feature_report']['ru-ru'] = "Отчет о кодах функций";
$text['title-feature_report']['sv-se'] = "Funktionskoder Rapport";
$text['title-feature_report']['uk-ua'] = "Звіт про коди функцій";
$text['title-feature_report']['tr-tr'] = "Özellik Kodları Raporu";
$text['title-feature_report']['zh-cn'] = "功能代码报告";
$text['title-feature_report']['ja-jp'] = "機能コードレポート";
$text['title-feature_report']['ko-kr'] = "기능 코드 보고서";

$text['description-feature_report']['en-us'] = "List of feature codes (star codes) available for dialing.";
$text['description-feature_report']['en-gb'] = "List of feature codes (star codes) available for dialing.";
$text['description-feature_report']['ar-eg'] = "قائمة رموز الميزات (رموز النجمة) المتاحة للاتصال.";
$text['description-feature_report']['de-at'] = "Liste der verfügbaren Funktionscodes (Sterncodes) zum Wählen.";
$text['description-feature_report']['de-ch'] = "Liste der verfügbaren Funktionscodes (Sterncodes) zum Wählen.";
$text['description-feature_report']['de-de'] = "Liste der verfügbaren Funktionscodes (Sterncodes) zum Wählen.";
$text['description-feature_report']['el-gr'] = "Λίστα κωδικών λειτουργιών (κωδικοί αστεριού) διαθέσιμων για κλήση.";
$text['description-feature_report']['es-cl'] = "Lista de códigos de funciones (códigos de asterisco) disponibles para marcar.";
$text['description-feature_report']['es-mx'] = "Lista de códigos de funciones (códigos de asterisco) disponibles para marcar.";
$text['description-feature_report']['fr-ca'] = "Liste des codes de fonctionnalités (codes étoile) disponibles pour la numérotation.";
$text['description-feature_report']['fr-fr'] = "Liste des codes de fonctionnalités (codes étoile) disponibles pour la numérotation.";
$text['description-feature_report']['he-il'] = "רשימת קודי תכונות (קודי כוכבית) זמינים לחיוג.";
$text['description-feature_report']['it-it'] = "Elenco dei codici funzione (codici asterisco) disponibili per la composizione.";
$text['description-feature_report']['nl-nl'] = "Lijst met beschikbare functiecodes (stercodes) om te bellen.";
$text['description-feature_report']['pl-pl'] = "Lista kodów funkcji (kodów gwiazdkowych) dostępnych do wybierania.";
$text['description-feature_report']['pt-br'] = "Lista de códigos de recursos (códigos de estrela) disponíveis para discagem.";
$text['description-feature_report']['pt-pt'] = "Lista de códigos de funcionalidades (códigos de estrela) disponíveis para marcação.";
$text['description-feature_report']['ro-ro'] = "Lista codurilor de funcții (coduri stea) disponibile pentru apelare.";
$text['description-feature_report']['ru-ru'] = "Список кодов функций (звездочных кодов), доступных для набора.";
$text['description-feature_report']['sv-se'] = "Lista över funktionskoder (stjärnkoder) tillgängliga för uppringning.";
$text['description-feature_report']['uk-ua'] = "Список кодів функцій (зіркові коди), доступних для набору.";
$text['description-feature_report']['tr-tr'] = "Arama için mevcut özellik kodlarının (yıldız kodları) listesi.";
$text['description-feature_report']['zh-cn'] = "可供拨打的功能代码（星号代码）列表。";
$text['description-feature_report']['ja-jp'] = "ダイヤル可能な機能コード（スターコード）のリスト。";
$text['description-feature_report']['ko-kr'] = "전화 걸기에 사용할 수 있는 기능 코드(별표 코드) 목록.";
