...
$text['title-gswave']['pt-br'] = "Grandstream Wave";
...
$text['title_description-gswave']['pt-br'] = "Grandstream Wave é um soft phone para smart fones ou tablets. Ele pode ser configurado facilmente com um QR code que é gerado aqui. Para usar, faça o download e instale o Grandstream Wave no seu dispositivo. Inicie a aplicação e vá para as configurações de conta e pressione + para adicionar uma nova conta. Pressione em 'UCM Account (Scan QR Code) então selecione o ramal e faça um scan no QR code.";
