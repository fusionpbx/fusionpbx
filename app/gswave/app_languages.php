...
$text['title-gswave']['el-gr'] = "Grandstream Wave";
...
$text['title-gswave']['tr-tr'] = "Büyük Akım Dalgası";
...
$text['title_description-gswave']['tr-tr'] = "Grandstream Wave, akıllı telefonlar veya tabletler için yumuşak bir telefondur. Burada sağlanan QR koduyla kolayca yapılandırılabilir. Kullanmak için cihazınıza Grandstream Wave'i indirip yükleyin. Uygulamayı başlatın ve ardından Hesap Ayarlarına giderek yeni bir hesap eklemek için + tuşuna basın. UCM Hesabına (QR Kodunu Tara) basın ve ardından uzantıyı seçin ve QR kodunu tarayın.";
