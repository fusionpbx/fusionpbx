...
$text['button-sweep']['en-us'] = "Sweep";
$text['button-sweep']['en-gb'] = "Sweep";
$text['button-sweep']['ar-eg'] = "كنس";
$text['button-sweep']['de-at'] = "Fegen";
$text['button-sweep']['de-ch'] = "Fegen";
$text['button-sweep']['de-de'] = "Fegen";
$text['button-sweep']['el-gr'] = "Σκούπισμα";
$text['button-sweep']['en-gb'] = "Sweep";
$text['button-sweep']['en-us'] = "Sweep";
$text['button-sweep']['es-cl'] = "Barrer";
$text['button-sweep']['es-mx'] = "Barrer";
$text['button-sweep']['fr-ca'] = "Balayer";
$text['button-sweep']['fr-fr'] = "Balayer";
$text['button-sweep']['he-il'] = "לְטַאטֵא";
$text['button-sweep']['it-it'] = "Spazzare";
$text['button-sweep']['ja-jp'] = "スイープ";
$text['button-sweep']['ka-ge'] = "Sweep";
$text['button-sweep']['ko-kr'] = "스위프";
$text['button-sweep']['nl-nl'] = "Vegen";
$text['button-sweep']['pl-pl'] = "Zamiatać";
$text['button-sweep']['pt-br'] = "Varrer";
$text['button-sweep']['pt-pt'] = "Varrer";
$text['button-sweep']['ro-ro'] = "Mătură";
$text['button-sweep']['ru-ru'] = "Мести";
$text['button-sweep']['sv-se'] = "Sopa";
$text['button-sweep']['tr-tr'] = "Süpürme";
$text['button-sweep']['uk-ua'] = "підмітати";
$text['button-sweep']['zh-cn'] = "扫";
