...
$text['option-anti-action']['pt-br'] = "Anti-Ação"; //copied from pt-pt
...
$text['option-action']['pt-br'] = "Ação"; //copied from pt-pt
...
$text['label-tag']['pt-br'] = "Etiqueta"; //copied from pt-pt
...
$text['label-extension']['pt-br'] = "Ramal"; //copied from pt-pt
...
$text['label-data']['pt-br'] = "Dados"; //copied from pt-pt
...
$text['label-agent_queue_extension']['pt-br'] = "Número de Ramal da Fila"; //copied from pt-pt
...
$text['label-agent_loginout_extension']['pt-br'] = "Número de Ramal para Login/Logout"; //copied from pt-pt
...
$text['header-queue_detail_add']['pt-br'] = "Adicionar Detalhes da Fila"; //copied from pt-pt
...
$text['header-conditions_and_actions']['pt-br'] = "Condições e Ações"; //copied from pt-pt
...
$text['description-queues']['pt-br'] = "As filas são utilizadas para configurar espera para os chamadores. Também são chamadas de filas FIFO."; //copied from pt-pt
...
$text['description-queue_edit']['pt-br'] = "AAs filas são utilizadas para configurar espera para os chamadores. Também são chamadas de filas FIFO."; //copied from pt-pt
...
$text['description-queue_add']['pt-br'] = "Em termos simples, filas são padrões de espera para chamadores até que exista alguém disponível para atender a chamada. Também conhecido como filas FIFO."; //copied from pt-pt
...
$text['description-continue']['pt-br'] = "A ação Continuar deverá ser, na maioria dos casos, definida como falso."; //copied from pt-pt
...
$text['description-conditions_and_actions']['pt-br'] = "As seguintes condições, ações e anti-ações são utilizadas no dialplan para encaminhar o fluxo das chamadas. Cada uma será processada em ordem até atingir a ação a executar. Podem ser tomadas mais do que uma condição ou ação para um determinado ramal."; //copied from pt-pt
...
$text['description-agent_queue_extension']['pt-br'] = "O número de ramal para o agente da fila. Este é o padrão de espera para que os agentes possam receber chamadas da fila."; //copied from pt-pt
...
$text['description-agent_loginout_extension']['pt-br'] = "Os agentes utilizam este número de ramal para entrarem ou sairem da fila. Depois de entrarem, o agente receberá chamadas com destino a esta fila."; //copied from pt-pt
