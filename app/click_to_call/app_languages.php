...
$text['desc-click2call']['zh-cn'] = "提供以下信息以从主叫号码拨打被叫号码。";
...
$text['label-src-caller-id-nam']['zh-cn'] = "主叫ID名称";
...
$text['desc-src-caller-id-nam']['zh-cn'] = "输入主叫ID名称。";
...
$text['label-src-caller-id-num']['zh-cn'] = "主叫ID号码";
...
$text['desc-src-caller-id-num']['zh-cn'] = "输入主叫ID号码（您可能希望该号码与被叫号码相同）。";
...
$text['label-dest-caller-id-nam']['zh-cn'] = "被叫ID名称";
...
$text['desc-dest-caller-id-nam']['zh-cn'] = "输入被叫ID名称。";
...
$text['label-dest-caller-id-num']['zh-cn'] = "被叫ID号码";
...
$text['desc-dest-caller-id-num']['zh-cn'] = "输入被叫ID号码（您可能希望这是您的电话号码）。";
...
$text['desc-src-num']['zh-cn'] = "输入您的电话号码。这可以是系统上的分机号，也可以是其他号码（例如：移动电话）.";
...
$text['label-dest-num']['zh-cn'] = "被叫号码";
...
$text['desc-dest-num']['zh-cn'] = "输入要拨打的号码。这可以是系统上的分机号、另一个号码或sip uri。Sip URI的形式如下5551234567@voip.example.com:5080（5080表示freeswitch，5060表示其他系统）。";
...
$text['desc-ringback']['zh-cn'] = "定义调用目标将听到的内容。选择是音乐（保留音乐）铃声（彩铃）。";
