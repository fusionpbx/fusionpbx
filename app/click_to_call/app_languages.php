...
$text['desc-click2call']['fr-ca'] = "Fournissez les informations suivantes pour passer un appel du numéro source au numéro de destination.";
...
$text['desc-dest-caller-id-nam']['fr-ca'] = "Choisir le nom d'appelant à envoyer à la destination";
