...
$text['description-event_socket_pass']['en-us'] = "Enter the event socket password.";
$text['description-event_socket_pass']['ar-eg'] = "";
$text['description-event_socket_pass']['de-at'] = "Geben Sie das Event Socket Passwort an."; //copied from de-de
$text['description-event_socket_pass']['de-ch'] = "Geben Sie das Event Socket Passwort an."; //copied from de-de
$text['description-event_socket_pass']['de-de'] = "Geben Sie das Event Socket Passwort an.";
$text['description-event_socket_pass']['es-cl'] = "Ingrese la contraseña del socket de eventos.";
$text['description-event_socket_pass']['es-mx'] = "Ingrese la contraseña del socket de eventos."; //copied from es-cl
$text['description-event_socket_pass']['fr-ca'] = "Mot de passe pour se connecter au module Event Socket."; //copied from fr-fr
$text['description-event_socket_pass']['fr-fr'] = "Mot de passe pour se connecter au module Event Socket.";
$text['description-event_socket_pass']['he-il'] = "";
$text['description-event_socket_pass']['it-it'] = "Inserire la password della event socket.";
$text['description-event_socket_pass']['nl-nl'] = "";
$text['description-event_socket_pass']['pl-pl'] = "Wprowadź hasło 'Event Socket'";
$text['description-event_socket_pass']['pt-br'] = "Introduza a palavra-chave do event socket. ";
$text['description-event_socket_pass']['pt-pt'] = "Introduza a palavra-chave do event socket.";
$text['description-event_socket_pass']['ro-ro'] = "";
$text['description-event_socket_pass']['ru-ru'] = "Введите пароль сокета событий.";
$text['description-event_socket_pass']['sv-se'] = "Fyll i event socket password.";
$text['description-event_socket_pass']['uk-ua'] = "Enter the event socket password. ";
