...
echo "	<input class='formfld' type='text' name='dialplan_number' id='dialplan_number' maxlength='255' value=\"".escape($dialplan_number ?? null)."\" required='required' placeholder='".$_SESSION['ranges']['time_condition_range']['text'] ?? ''."'>\n";
echo "	<br />\n";
