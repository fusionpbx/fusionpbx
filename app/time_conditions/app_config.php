<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'USA Holiday';
                ...
                //define Italy holiday presets
                $y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '3df096bb-ae96-4765-96da-a32e90b51940';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"new_years_day":{"mday":"1", "mon":"1"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '1ce5cd4b-7181-4b33-92b0-2cf4a9af2fa3';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"epiphany_day":{"mday":"6", "mon":"1"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '09578bc4-60e8-44c1-b51d-943de4ee5b9f';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"liberation_day":{"mday":"25", "mon":"4"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '0aa94074-a339-47d6-b6ab-c264c3786074';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"firstmay_day":{"mday":"1", "mon": "5"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'be512c08-029e-49a0-937d-1762fc029609';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"republic_day":{"mday":"2", "mon":"6"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '261a0ea4-26a3-4bb1-95e5-888afd221ca0';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"assumption_day":{"mday":"15", "mon":"8"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '827d34db-b0ed-4690-8641-8ed01052e303';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"allsaints_day":{"mday":"1", "mon":"11"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'c1fdfebe-3544-4b01-8a83-d0fee8e96a7a';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"immaculate_day":{"mday":"8", "mon":"12"}}';
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = '82e3ee39-27a4-4d70-8436-11058d3e51e7';
		$apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
		$apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
		$apps[$x]['default_settings'][$y]['default_setting_value'] = '{"christmas_day":{"mday":"25", "mon":"12"}}';
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
                $y++;
                $apps[$x]['default_settings'][$y]['default_setting_uuid'] = 'a2e3ee39-2aa4-4d70-8436-11058d3e51e7';
                $apps[$x]['default_settings'][$y]['default_setting_category'] = 'time_conditions';
                $apps[$x]['default_settings'][$y]['default_setting_subcategory'] = 'preset_ita';
                $apps[$x]['default_settings'][$y]['default_setting_name'] = 'array';
                $apps[$x]['default_settings'][$y]['default_setting_value'] = '{"sstephen_day":{"mday":"26", "mon":"12"}}';
                $apps[$x]['default_settings'][$y]['default_setting_enabled'] = 'true';
                $apps[$x]['default_settings'][$y]['default_setting_description'] = 'ITA Holiday';
