        ...
        if ((empty($_POST["persistformvar"]) || $_POST["persistformvar"] != "true") && permission_exists('voicemail_greeting_edit')) {
                ...
                if (!empty($greeting_id)) {
                        ...
                        if ($speech_enabled && !empty($greeting_voice) && !empty($greeting_message)) {
                                ...
                                if ($action == 'update' && isset($_POST["create_recording"]) && $_POST["create_recording"] == 'true') {
                                        $create_recording = true;
                                }
                        }
...
//show the content
        ...
        if ($speech_enabled || $transcribe_enabled) {
                ...
                // Update Recording toggle (only show when editing)
                if ($action == 'update') {
                        echo "<tr>\n";
                        ...
                        echo "          <option value='false'>".($text['option-false'] ?? 'false')."</option>\n";
                        echo "          <option value='true'>".($text['option-true'] ?? 'true')."</option>\n";
                        echo "  </select>\n";
                        if ($input_toggle_style_switch) {
                                echo "          <span class='slider'></span>\n";
                                echo "  </span>\n";
                        ...
                        echo "<br />\n";
                        echo "When enabled a recording will be created to replace the previous one.\n";
                        echo "</td>\n";
                        echo "</tr>\n";
                }
        }
