<?php
	...
	$text['title']['fr'] = "Salutations de la messagerie";
	...
	$text['description']['fr'] = "Choisir le message de salutation à jouer pour l'extension:";

	$text['label-upload']['en-us'] = 'File to Upload';
	$text['label-upload']['pt-pt'] = 'Ficheiro a Carregar';
	$text['label-upload']['fr'] = 'Fichier à télécharger';

	$text['table-choose']['en-us'] = 'Choose';
	$text['table-choose']['pt-pt'] = 'Escolher';
	$text['table-choose']['fr'] = 'Choisir';
	...
	$text['table-download']['fr'] = 'Télécharger';
	...
	$text['confirm-name']['fr'] = "Merci d'indiquer: Nom de salutation (jouer)";
	...
	$text['description-name']['fr'] = 'Nome da Salutation. exemple: accueil_x';
