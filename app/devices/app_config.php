...
//grandstream
		...
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "6d9d7e72-2f3c-45ae-8885-c7761a9103c9";
		$vendors[$y]['functions'][$z]['label'] = "label-call_log";
		$vendors[$y]['functions'][$z]['name'] = "call_log";
		$vendors[$y]['functions'][$z]['value'] = "call log";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		...
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "cdf28038-29a7-4003-b178-d0c5cce477bd";
		$vendors[$y]['functions'][$z]['label'] = "label-xml_application";
		$vendors[$y]['functions'][$z]['name'] = "xml_application";
		$vendors[$y]['functions'][$z]['value'] = "xml application";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "7e88d133-ec16-49e5-92d6-ab116d476414";
		$vendors[$y]['functions'][$z]['label'] = "label-information";
		$vendors[$y]['functions'][$z]['name'] = "information";
		$vendors[$y]['functions'][$z]['value'] = "information";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "5045e13b-4c8f-4782-9565-b55a1ec1bb95";
		$vendors[$y]['functions'][$z]['label'] = "label-message";
		$vendors[$y]['functions'][$z]['name'] = "message";
		$vendors[$y]['functions'][$z]['value'] = "message";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "b84072f7-7259-497b-a20d-31616ccab6df";
		$vendors[$y]['functions'][$z]['label'] = "label-forward";
		$vendors[$y]['functions'][$z]['name'] = "forward";
		$vendors[$y]['functions'][$z]['value'] = "forward";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "af267c2b-0257-477f-aac6-15fab6fccbba";
		$vendors[$y]['functions'][$z]['label'] = "label-dnd";
		$vendors[$y]['functions'][$z]['name'] = "dnd";
		$vendors[$y]['functions'][$z]['value'] = "dnd";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "c119be67-828d-4346-8020-9631544636c8";
		$vendors[$y]['functions'][$z]['label'] = "label-redial";
		$vendors[$y]['functions'][$z]['name'] = "redial";
		$vendors[$y]['functions'][$z]['value'] = "redial";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "0555c72a-dbbd-42e4-b696-d7f82f022c2a";
		$vendors[$y]['functions'][$z]['label'] = "label-instant_messages";
		$vendors[$y]['functions'][$z]['name'] = "instant_messages";
		$vendors[$y]['functions'][$z]['value'] = "instant messages";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "1a680c3d-9580-46cf-b3ed-e2bb8f5954e4";
		$vendors[$y]['functions'][$z]['label'] = "label-multicast_listen_address";
		$vendors[$y]['functions'][$z]['name'] = "multicast_listen_address";
		$vendors[$y]['functions'][$z]['value'] = "multicast listen address";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;
		$vendors[$y]['functions'][$z]['uuid'] = "636ded2c-60ad-46cd-882f-8afd3e95263f";
		$vendors[$y]['functions'][$z]['label'] = "label-keyd_lock";
		$vendors[$y]['functions'][$z]['name'] = "keypad_lock";
		$vendors[$y]['functions'][$z]['value'] = "keypad lock";
		$vendors[$y]['functions'][$z]['groups'][] = "superadmin";
		$vendors[$y]['functions'][$z]['groups'][] = "admin";
		$z++;	
//mitel
