...
//devices icon
$array['dashboard'][$x]['dashboard_uuid'] = 'd93648da-af16-4018-9182-76e8820ffe56';
$array['dashboard'][$x]['dashboard_name'] = 'Devices';
$array['dashboard'][$x]['dashboard_path'] = 'dashboard/icon';
$array['dashboard'][$x]['dashboard_icon'] = 'fa-mobile-retro';
$array['dashboard'][$x]['dashboard_url'] = '/app/devices/devices.php';
$array['dashboard'][$x]['dashboard_target'] = 'self';
$array['dashboard'][$x]['dashboard_width'] = '';
$array['dashboard'][$x]['dashboard_height'] = '';
$array['dashboard'][$x]['dashboard_content'] = '';
...
$y = 0;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '84452fd4-2409-427b-8382-96bfb38fdf49';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'd93648da-af16-4018-9182-76e8820ffe56';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'superadmin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = '5d026f9d-3fbb-4d4a-b654-bef32ea8bdef';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'd93648da-af16-4018-9182-76e8820ffe56';
