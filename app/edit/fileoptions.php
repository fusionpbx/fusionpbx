...
//show the content
	...
	echo "				<tr><td><input type='button' class='btn' onclick=\"window.location='filedelete.php?folder='+document.getElementById('folder').value+'&file='+document.getElementById('filename').value;\" value='".$text['button-del-file']."'></td></tr>\n";
	echo "				<tr><td><input type='button' class='btn' onclick=\"window.location='folderdelete.php?folder='+document.getElementById('folder').value;\" value='".$text['button-del-dir']."'></td></tr>\n";
