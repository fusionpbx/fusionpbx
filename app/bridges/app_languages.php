<?php
	...
	//Bridges
		...
		$text['title_description-bridge']['zh-cn'] = '将网桥语句添加到目标选择列表。';
		...
		$text['label-bridge_destination']['zh-cn'] = '描述';
		...
		$text['description-bridge_destination']['zh-cn'] = '输入描述。';
		...
		$text['description-bridge_description']['zh-cn'] = '输入描述。';
