<?php
	...
	//Bridges
		...
		$text['label-bridge_data']['en-us'] = 'Data';
		$text['label-bridge_data']['ar-eg'] = '';
		$text['label-bridge_data']['de-at'] = '';
		$text['label-bridge_data']['de-ch'] = '';
		$text['label-bridge_data']['de-de'] = '';
		$text['label-bridge_data']['es-cl'] = '';
		$text['label-bridge_data']['es-mx'] = '';
		$text['label-bridge_data']['fr-ca'] = '';
		$text['label-bridge_data']['fr-fr'] = '';
		$text['label-bridge_data']['he-il'] = '';
		$text['label-bridge_data']['it-it'] = '';
		$text['label-bridge_data']['nl-nl'] = '';
		$text['label-bridge_data']['pl-pl'] = '';
		$text['label-bridge_data']['pt-br'] = '';
		$text['label-bridge_data']['pt-pt'] = '';
		$text['label-bridge_data']['ro-ro'] = '';
		$text['label-bridge_data']['ru-ru'] = '';
		$text['label-bridge_data']['sv-se'] = '';
		$text['label-bridge_data']['uk-ua'] = '';

		$text['description-bridge_data']['en-us'] = 'Enter the data.';
		$text['description-bridge_data']['ar-eg'] = '';
		$text['description-bridge_data']['de-at'] = '';
		$text['description-bridge_data']['de-ch'] = '';
		$text['description-bridge_data']['de-de'] = '';
		$text['description-bridge_data']['es-cl'] = '';
		$text['description-bridge_data']['es-mx'] = '';
		$text['description-bridge_data']['fr-ca'] = '';
		$text['description-bridge_data']['fr-fr'] = '';
		$text['description-bridge_data']['he-il'] = '';
		$text['description-bridge_data']['it-it'] = '';
		$text['description-bridge_data']['nl-nl'] = '';
		$text['description-bridge_data']['pl-pl'] = '';
		$text['description-bridge_data']['pt-br'] = '';
		$text['description-bridge_data']['pt-pt'] = '';
		$text['description-bridge_data']['ro-ro'] = '';
		$text['description-bridge_data']['ru-ru'] = '';
		$text['description-bridge_data']['sv-se'] = '';
		$text['description-bridge_data']['uk-ua'] = '';
