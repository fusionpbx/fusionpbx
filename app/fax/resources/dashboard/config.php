...
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = 'e258a8b7-38e4-4faa-a788-db4b1340730b';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'ea3f5a8a-fc93-47d7-a632-a733522affc3';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'admin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = 'cb7bd2f0-6e3d-4624-b576-ef818a974250';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = 'ea3f5a8a-fc93-47d7-a632-a733522affc3';
