<?php
	...
	$text['description']['fr'] = "Afin de recevoir un Fax, configurer une extension et rediriger l'appel sur celle-ci.";
	...
	$text['label-upload']['fr'] = "Télécharegr";
	...
	$text['description-upload']['fr'] = "Choisir un fichier à télécharger pour être émis en tant que Fax.";
	...
	$text['button-settings']['fr'] = "Configuration";

	$text['button-send']['en-us'] = 'Send';
	$text['button-send']['pt-pt'] = 'Enviar';
	$text['button-send']['fr'] = "Envoyer";
	...
	$text['description-extension']['fr'] = "Choisir un numéro d'extension.";
	...
	$text['description-destination-number']['fr'] = "";
	...
	$text['description-email']['fr'] = "Choisir un courriel où envoyer le Fax.";
	...
	$text['description-caller-id-name']['fr'] = "Choisir le nom affiché en entête du Fax émis";
	...
	$text['description-caller-id-number']['fr'] = "Choisir le numéro affiché en entête du Fax émis";

	$text['label-forward']['en-us'] = 'Forward Number';
	$text['label-forward']['pt-pt'] = 'Número de Encaminhamento';
	$text['label-forward']['fr'] = "Numéro de renvoi";
	...
	$text['description-forward-number']['fr'] = "Choisir un numéro de renvoi en cas de besoins. Si inséré, après réception, le Fax sera ré-émis à ce numéro.";

	$text['label-user-list']['en-us'] = 'User List';
	$text['label-user-list']['pt-pt'] = 'Lista de utilizadores';
	$text['label-user-list']['fr'] = "Liste Usagers";
	...
	$text['description-user-add']['fr'] = "Ajouter les usagers pouvant utiliser ce Fax.";

	$text['label-file']['en-us'] = 'File not found.';
	$text['label-file']['pt-pt'] = 'Ficheiro não encontrado.';
	$text['label-file']['fr'] = "Fichier non trové";
	...
	$text['description-2']['fr'] = "Pour envoyer un fax, vous pouvez télécharger un fichier <b>TIF</b>. Si ghost script a été installé, vous pouvez également utiliser un fichier <b>PDF</b>.";
