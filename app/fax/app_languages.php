...
$text['label-fax-footer']['it-it'] = "Pi�è di pagina";
...
$text['description-fax_log']['it-it'] = "I dettagli per spedire e ricevere un fax sono se il fax è stato inviato/ricevuto, ECM (Error Correction Mode), numero tentativi, numero destinazione, data, etc.";
...
$text['description-fax-resolution']['it-it'] = "Selezionare la qualità di trasmissione.";
