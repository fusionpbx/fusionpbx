...
$text['label-ring-timeout']['ru-ru'] = "Таймаут";
...
$text['label-prompt']['ru-ru'] = "Подтверждение приема звонка";
...
$text['label-call-prompt']['ru-ru'] = "Запрос звонка";
...
$text['description-ignore_busy']['ru-ru'] = "Прервать звонок, если конечная точка занята.";
...
$text['description-call-prompt']['ru-ru'] = "Сообщение о приеме звонка для внешних направлений.";
...
$text['description-call_forward']['ru-ru'] = "Переадресовать все звонки на указанные направления.";
