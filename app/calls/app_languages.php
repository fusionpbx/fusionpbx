<?php
	...
	$text['description']['fr'] = "Rediriger les appels entrant pour l'extension:";
	...
	$text['description-2']['fr'] = "Utiliser les liens afin de configurer le renvoi \"follow me\", ou ne pas derranger.";
	...
	$text['description-3']['fr'] = "Ici la liste des extensions assignées à cet usager.";

	$text['label-call-forward']['en-us'] = 'Call Forward';
	$text['label-call-forward']['pt-pt'] = 'Encaminhamento de Chamadas';
	$text['label-call-forward']['fr'] = "Renvoi d'appel";
