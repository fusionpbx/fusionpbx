<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = generate_password(!empty($settings->get('voicemail', 'password_length')) && is_numeric($settings->get('voicemail', 'password_length')) ? $settings->get('voicemail', 'password_length') : 8, 1);
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
