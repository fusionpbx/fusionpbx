...
$y = 0;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = 'ac4a9b75-df8d-4210-8ccd-001de9dc7a6b';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = '3d8efe65-49c3-4783-844e-4ebc1c97db68';
$array['dashboard'][$x]['dashboard_groups'][$y]['group_name'] = 'superadmin';
$y++;
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_group_uuid'] = 'eaa583b0-eca5-4266-a0f9-e06f0fa14288';
$array['dashboard'][$x]['dashboard_groups'][$y]['dashboard_uuid'] = '3d8efe65-49c3-4783-844e-4ebc1c97db68';
