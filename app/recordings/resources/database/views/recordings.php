...
$view['name'] = "view_recording_map";
$view['version'] = "20260610";
$view['description'] = "Show all the recordings locations throughougt the system where they are being used.";
$view['sql'] = "select \n";
...
$view['sql'] .= "where hold_music like '%/recordings/%' \n";
...
$view['sql'] .= "where ring_group_ringback like '%/recordings/%' \n";
...
$view['sql'] .= "where ivr_menu_ringback like '%/recordings/%' \n";
...
$view['sql'] .= "where queue_moh_sound like '%/recordings/%' \n";
...
$view['sql'] .= "where fifo_music like '%/recordings/%' \n";
...
$view['sql'] .= "where destination_hold_music like '%/recordings/%' \n";
$view['sql'] .= "and e.domain_uuid = d.domain_uuid \n";
$view['sql'] .= "union \n";
$view['sql'] .= "select \n";
$view['sql'] .= " 'destinations' as application, \n";
...
$view['sql'] .= " e.destination_description as description \n";
$view['sql'] .= "from v_destinations as e, v_domains as d \n";
$view['sql'] .= "where destination_ringback like '%/recordings/%' \n";
$view['sql'] .= "and e.domain_uuid = d.domain_uuid \n";
$view['sql'] .= "union \n";
$view['sql'] .= "select \n";
...
$view['sql'] .= "where dialplan_detail_data like '%/recordings/%' \n";
