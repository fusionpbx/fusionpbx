...
$text['title-recordings_map']['en-us'] = "Recordings Map";
$text['title-recordings_map']['en-gb'] = "Recordings Map";
$text['title-recordings_map']['ar-eg'] = "خريطة التسجيلات";
$text['title-recordings_map']['de-at'] = "Aufzeichnungskarte";
$text['title-recordings_map']['de-ch'] = "Aufzeichnungskarte";
$text['title-recordings_map']['de-de'] = "Aufzeichnungskarte";
$text['title-recordings_map']['el-gr'] = "Χάρτης Καταγραφών";
$text['title-recordings_map']['es-cl'] = "Mapa de Grabaciones";
$text['title-recordings_map']['es-mx'] = "Mapa de Grabaciones";
$text['title-recordings_map']['fr-ca'] = "Carte des Enregistrements";
$text['title-recordings_map']['fr-fr'] = "Carte des Enregistrements";
$text['title-recordings_map']['he-il'] = "מפת ההקלטות";
$text['title-recordings_map']['it-it'] = "Mappa delle Registrazioni";
$text['title-recordings_map']['ka-ge'] = "ჩანაწერების რუკა";
$text['title-recordings_map']['nl-nl'] = "Opnamekaart";
$text['title-recordings_map']['pl-pl'] = "Mapa Nagrań";
$text['title-recordings_map']['pt-br'] = "Mapa de Gravações";
$text['title-recordings_map']['pt-pt'] = "Mapa de Gravações";
$text['title-recordings_map']['ro-ro'] = "Harta Înregistrărilor";
$text['title-recordings_map']['ru-ru'] = "Карта Записей";
$text['title-recordings_map']['sv-se'] = "Inspelningskarta";
$text['title-recordings_map']['uk-ua'] = "Карта записів";
$text['title-recordings_map']['tr-tr'] = "Kayıtlar Haritası";
$text['title-recordings_map']['zh-cn'] = "录音地图";
$text['title-recordings_map']['ja-jp'] = "録音マップ";
$text['title-recordings_map']['ko-kr'] = "녹음 지도";

$text['title_description-recordings_map']['en-us'] = 'The recordings map is a searchable directory of all locations where recordings are being used. It simplifies maintenance by offering a centralized view of these locations to update them as needed.';
$text['title_description-recordings_map']['en-gb'] = 'The recordings map is a searchable directory of all locations where recordings are being used. It simplifies maintenance by offering a centralised view of these locations to update them as needed.';
$text['title_description-recordings_map']['ar-eg'] = 'خريطة التسجيلات هي دليل قابل للبحث عن جميع المواقع التي تُستخدم فيها التسجيلات. تُبسّط عملية الصيانة من خلال عرض مركزي لهذه المواقع يتيح تحديثها عند الحاجة.';
$text['title_description-recordings_map']['de-at'] = 'Die Übersicht der Aufzeichnungen ist ein durchsuchbarer Katalog aller Standorte, an denen Aufzeichnungen verwendet werden. Sie vereinfacht die Wartung, indem sie eine zentrale Ansicht dieser Standorte bietet, um sie bei Bedarf zu aktualisieren.';
$text['title_description-recordings_map']['de-ch'] = 'Die Übersicht der Aufzeichnungen ist ein durchsuchbarer Katalog aller Standorte, an denen Aufzeichnungen verwendet werden. Sie vereinfacht die Wartung, indem sie eine zentrale Ansicht dieser Standorte bietet, um sie bei Bedarf zu aktualisieren.';
$text['title_description-recordings_map']['de-de'] = 'Die Übersicht der Aufzeichnungen ist ein durchsuchbarer Katalog aller Standorte, an denen Aufzeichnungen verwendet werden. Sie vereinfacht die Wartung, indem sie eine zentrale Ansicht dieser Standorte bietet, um sie bei Bedarf zu aktualisieren.';
$text['title_description-recordings_map']['el-gr'] = 'Ο χάρτης των ηχογραφήσεων είναι ένας αναζητήσιμος κατάλογος όλων των τοποθεσιών όπου χρησιμοποιούνται οι ηχογραφήσεις. Απλοποιεί τη συντήρηση προσφέροντας μια ενοποιημένη προβολή αυτών των τοποθεσιών για την ενημέρωσή τους όπως απαιτείται.';
$text['title_description-recordings_map']['es-cl'] = 'El mapa de grabaciones es un directorio buscable de todas las ubicaciones donde se utilizan las grabaciones. Simplifica el mantenimiento ofreciendo una vista centralizada de estas ubicaciones para actualizarlas según sea necesario.';
$text['title_description-recordings_map']['es-mx'] = 'El mapa de grabaciones es un directorio buscable de todas las ubicaciones donde se utilizan las grabaciones. Simplifica el mantenimiento ofreciendo una vista centralizada de estas ubicaciones para actualizarlas según sea necesario.';
$text['title_description-recordings_map']['fr-ca'] = 'La carte des enregistrements est un répertoire consultable de tous les emplacements où les enregistrements sont utilisés. Elle simplifie la maintenance en offrant une vue centralisée de ces emplacements pour les mettre à jour selon les besoins.';
$text['title_description-recordings_map']['fr-fr'] = 'La carte des enregistrements est un répertoire consultable de tous les emplacements où les enregistrements sont utilisés. Elle simplifie la maintenance en offrant une vue centralisée de ces emplacements pour les mettre à jour selon les besoins.';
$text['title_description-recordings_map']['he-il'] = 'מפת ההקלטות היא ספרית נתיקה של כל המיקומים בהם משתמשים בהקלטות. היא מפשטת את התחזוקה על ידי הצגת תצוגה מרכזית של מיקומים אלו כדי לעדכן אותם לפי הצורך.';
$text['title_description-recordings_map']['it-it'] = 'La mappa delle registrazioni è un elenco ricercabile di tutte le posizioni in cui vengono utilizzate le registrazioni. Semplifica la manutenzione offrendo una vista centralizzata di queste posizioni per aggiornarle secondo necessità.';
$text['title_description-recordings_map']['nl-nl'] = 'Het opnamemap is een doorzoekbaar overzicht van alle locaties waar opnames worden gebruikt. Het vereenvoudigt het onderhoud door een gecentraliseerd beeld te bieden van deze locaties, zodat ze indien nodig bijgewerkt kunnen worden.';
$text['title_description-recordings_map']['pl-pl'] = 'Mapa nagrań to wyszukiwalny katalog wszystkich lokalizacji, w których wykorzystywane są nagrania. Upraszcza konserwację dzięki scentralizowanemu widokowi tych lokalizacji, umożliwiając ich aktualizację według potrzeb.';
$text['title_description-recordings_map']['pt-br'] = 'O mapa de gravações é um diretório pesquisável de todos os locais onde as gravações estão sendo utilizadas. Simplifica a manutenção ao oferecer uma visão centralizada desses locais para atualizá-los conforme necessário.';
$text['title_description-recordings_map']['pt-pt'] = 'O mapa de gravações é um diretório pesquisável de todos os locais onde as gravações estão sendo utilizadas. Simplifica a manutenção ao oferecer uma visão centralizada desses locais para atualizá-los conforme necessário.';
$text['title_description-recordings_map']['ro-ro'] = 'Harta înregistrărilor este un director căutabil al tuturor locațiilor unde sunt utilizate înregistrările. Simplifică mentenanța oferind o vedere centralizată a acestor locații pentru a le actualiza după caz.';
$text['title_description-recordings_map']['ru-ru'] = 'Карта записей представляет собой справочник всех мест, где используются записи. Она упрощает обслуживание благодаря централизованному обзору этих мест, позволяя обновлять их при необходимости.';
$text['title_description-recordings_map']['sv-se'] = 'Inspelningskartan är en sökbar katalog över alla platser där inspelningar används. Den förenklar underhållet genom att erbjuda en centraliserad översikt över dessa platser så att de kan uppdateras vid behov.';
$text['title_description-recordings_map']['uk-ua'] = 'Карта записів є пошуковим довідником усіх місць, де використовуються записи. Вона спрощує технічне обслуговування, надаючи централізований огляд цих місць для їх оновлення за потреби.';
$text['title_description-recordings_map']['tr-tr'] = 'Kayıt haritası, kayıtların kullanıldığı tüm konumların aranabilir bir dizinidir. Bu konumların merkezi bir görünümünü sunarak gerektiğinde güncellenebilmesine olanak tanır ve bakımı kolaylaştırır.';
$text['title_description-recordings_map']['zh-cn'] = '录音地图是一个可搜索的目录，列出了所有使用录音的位置。它通过提供这些位置的集中视图来简化维护工作，便于随时更新。';
$text['title_description-recordings_map']['ja-jp'] = 'レコーディングマップは、レコーディングが使用されているすべてのロケーションを検索可能なディレクトリです。これらのロケーションを一元的に表示し、必要に応じて更新できるようにすることで、保守作業を簡素化します。';
$text['title_description-recordings_map']['ko-kr'] = '녹음 맵은 녹음이 사용되고 있는 모든 위치를 검색할 수 있는 디렉토리입니다. 이러한 위치들을 중앙에서 한눈에 볼 수 있도록 제공하여 필요시 업데이트할 수 있게 함으로써 유지보수를 간소화합니다.';
