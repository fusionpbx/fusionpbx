...
//check permissions
	if (!permission_exists('recording_map')) {
		echo "access denied";
		exit;
	}
...
//show the content
	...
	echo "	<div class='heading'><b>".$text['title-recordings_map']."</b><div class='count'>".number_format($num_rows)."</div></div>\n";
	...
	echo $text['title_description-recordings_map']."\n";
	echo "<br /><br />\n";
