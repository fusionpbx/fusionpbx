...
//show the content
	...
	if (permission_exists('ring_group_add') && (!isset($settings->get('limit', 'ring_groups')) || ($total_ring_groups < $settings->get('limit', 'ring_groups')))) {
	...
	if (permission_exists('ring_group_add') && $ring_groups && (!isset($settings->get('limit', 'ring_groups')) || ($total_ring_groups < $settings->get('limit', 'ring_groups')))) {
