...
$text['title-dialplan_manager']['it-it'] = "Gestione Piano Numerazioni";
...
$text['title-dialplan_edit']['it-it'] = "Piano Numerazioni";
...
$text['title-dialplan_detail']['it-it'] = "Dettaglio Piano Numerazioni";
...
$text['title-dialplan_add']['it-it'] = "Piano Numerazioni";
...
$text['title-default_dialplan']['it-it'] = "Piano Numerazioni di Default";
...
$text['title-outbound_routes']['it-it'] = "Rotte di Uscita";
...
$text['title-inbound_routes']['it-it'] = "Rotte di Ingresso";
...
$text['option-check_voicemail']['it-it'] = "Controlla Casella Vocale";
...
$text['option-company_directory']['it-it'] = "Rubrica Aziendale";
...
$text['option-hangup']['it-it'] = "Chiudi";
...
$text['option-record']['it-it'] = "Registra";
...
$text['option-regex']['it-it'] = "Espress. Regolare";
...
$text['option-on_true']['it-it'] = "Se Vero";
...
$text['option-on_false']['it-it'] = "Se Falso";
...
$text['option-minute_of_day']['it-it'] = "Minuto del Giorno";
...
$text['option-dialplan']['it-it'] = "Piano Numerazioni";
...
$text['option-day_of_month']['it-it'] = "Giorno del Mese";
...
$text['option-caller_id_number']['it-it'] = "ID Numerochiamante";
...
$text['label-inline']['it-it'] = "Inline";
...
$text['label-dialplan_detail']['it-it'] = "Dettagli Piano Numerazioni";
...
$text['header-outbound_routes']['it-it'] = "Rotte di Uscita";
...
$text['header-inbound_routes']['it-it'] = "Rotte di Ingresso";
...
$text['header-dialplan_manager']['it-it'] = "Gestione Piano Numerazioni";
...
$text['header-dialplan_detail']['it-it'] = "Dettagli Piano Numerazioni";
...
$text['header-dialplan-edit']['it-it'] = "Piano Numerazioni";
...
$text['header-dialplan-add']['it-it'] = "Piano Numerazioni";
...
$text['header-default_dialplan']['it-it'] = "Piano Numerazioni di Default";
...
$text['description-outbound_routes']['it-it'] = "Istrada le chiamate in uscita ai gateways, alla tdm, enum e altro. Quando una chiamata verifica le condizioni viene passata alle rotte di uscita.";
...
$text['description-inbound_routes']['it-it'] = "Dirotta le chiamate in ingresso verso destinazioni basate su una o più condizioni. Può inviare le chiamate in ingresso verso IVR, Gruppi di squillo, Interni, Numeri Esterni, Script. L'ordine è importante quando si usano le anti-azioni o quando ci sono più condizioni da verificare. ";
...
$text['description-dialplan_manager-superadmin']['it-it'] = "Il Piano Numerazioni è usato per configurare le destinazioni di chiamata basate su condizioni e contesti. Puoi usarlo per mandare le chiamate verso gateways, risponditori, numeri esterni, scripts o qualsia altra destinazione. 	";
...
$text['description-dialplan_manager']['it-it'] = "Il piano numerazioni permette di vedere alcuni feature codes, i menu IVR, le Conferenze, le Code e altre destinazioni.";
...
$text['description-dialplan-edit']['it-it'] = "Parametri generali inclusi nel Piano Numerazioni.";
...
$text['description-default_dialplan']['it-it'] = "Il Piano Numerazioni è usato per configurare le destinazioni di chiamata basate su condizioni e contesti. Puoi usarlo per mandare le chiamate verso gateways, risponditori, numeri esterni, scripts o qualsia altra destinazione.";
...
$text['description-conditions_and_actions']['it-it'] = "Le seguenti condizioni, azioni e anti-azioni sono usate nel piano numerazioni per dirigere il flusso di chiamata. Ognuna è processata secondo l'ordine dato. Usa quante azioni, condizioni, o anti-azioni hai bisogno.";
...
$text['billing-warning']['it-it'] = "Se usi l'applicazione per la fatturazione di fusionpbx, accertati di inserire le variabili accountcode e carrier.";
