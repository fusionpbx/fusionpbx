...
$text['label-tier_rule_no_agent_no_wait']['en-us'] = "Can be True or False. If True, callers will skip tiers that don't have agents available. Otherwise, they are be required to wait before advancing. Agents must be logged off to be considered not available.";
$text['label-tier_rule_no_agent_no_wait']['en-gb'] = "Can be True or False. If True, callers will skip tiers that don't have agents available. Otherwise, they are be required to wait before advancing. Agents must be logged off to be considered not available.";
...
$text['label-tier_rule_no_agent_no_wait']['es-cl'] = "Puede ser Verdadero o Falso. Si es Verdadero, las personas que llaman omitirán los niveles que no tienen agentes disponibles. De lo contrario, deberán esperar antes de avanzar. Los agentes deben estar desconectados para ser considerados no disponibles.";
$text['label-tier_rule_no_agent_no_wait']['es-mx'] = "Puede ser Verdadero o Falso. Si es Verdadero, las personas que llaman omitirán los niveles que no tienen agentes disponibles. De lo contrario, deberán esperar antes de avanzar. Los agentes deben estar desconectados para ser considerados no disponibles.";
$text['label-tier_rule_no_agent_no_wait']['fr-ca'] = "Peut être vrai ou faux. Si True, les appelants ignoreront les niveaux pour lesquels aucun agent n’est disponible. Dans le cas contraire, ils devront attendre avant d'avancer. Les agents doivent être déconnectés pour être considérés comme non disponibles.";
$text['label-tier_rule_no_agent_no_wait']['fr-fr'] = "Peut être vrai ou faux. Si True, les appelants ignoreront les niveaux pour lesquels aucun agent n’est disponible. Dans le cas contraire, ils devront attendre avant d'avancer. Les agents doivent être déconnectés pour être considérés comme non disponibles.";
...
$text['description-tier_rule_wait_second']['en-us'] = "The time in seconds that a caller is required to wait before advancing to the next tier. This will be multiplied by the tier level if tier-rule-wait-multiply-level is set to True. If tier-rule-wait-multiply-level is set to false, then after tier-rule-wait-second's have passed, all tiers are open for calls in the tier-order and no advancement (in terms of waiting) to another tier is made.";
$text['description-tier_rule_wait_second']['en-gb'] = "The time in seconds that a caller is required to wait before advancing to the next tier. This will be multiplied by the tier level if tier-rule-wait-multiply-level is set to True. If tier-rule-wait-multiply-level is set to false, then after tier-rule-wait-second's have passed, all tiers are open for calls in the tier-order and no advancement (in terms of waiting) to another tier is made.";
...
$text['description-tier_rule_wait_second']['es-cl'] = "El tiempo en segundos que una persona que llama debe esperar antes de avanzar al siguiente nivel. Esto se multiplicará por el nivel de nivel si tier-rule-wait-multiply-level está establecido en True. Si tier-rule-wait-multiply-level se establece en falso, luego de que hayan pasado los segundos de espera de regla de nivel, todos los niveles están abiertos para llamadas en el orden de niveles y no se avanza (en términos de espera) a otro nivel. está hecho.";
$text['description-tier_rule_wait_second']['es-mx'] = "El tiempo en segundos que una persona que llama debe esperar antes de avanzar al siguiente nivel. Esto se multiplicará por el nivel de nivel si tier-rule-wait-multiply-level está establecido en True. Si tier-rule-wait-multiply-level se establece en falso, luego de que hayan pasado los segundos de espera de regla de nivel, todos los niveles están abiertos para llamadas en el orden de niveles y no se avanza (en términos de espera) a otro nivel. está hecho.";
$text['description-tier_rule_wait_second']['fr-ca'] = "Temps en secondes pendant lequel un appelant doit attendre avant de passer au niveau suivant. Celui-ci sera multiplié par le niveau de niveau si tier-rule-wait-multiply-level est défini sur True. Si tier-rule-wait-multiply-level est défini sur false, alors une fois les tier-rule-wait-second passés, tous les niveaux sont ouverts aux appels dans l'ordre des niveaux et aucun avancement (en termes d'attente) vers un autre niveau est fait.";
$text['description-tier_rule_wait_second']['fr-fr'] = "Temps en secondes pendant lequel un appelant doit attendre avant de passer au niveau suivant. Celui-ci sera multiplié par le niveau de niveau si tier-rule-wait-multiply-level est défini sur True. Si tier-rule-wait-multiply-level est défini sur false, alors une fois les tier-rule-wait-second passés, tous les niveaux sont ouverts aux appels dans l'ordre des niveaux et aucun avancement (en termes d'attente) vers un autre niveau est fait.";
...
$text['description-tier_rule_wait_multiply_level']['en-gb'] = "Can be True or False. If False, then once tier-rule-wait-second is passed, the caller is offered to all tiers in order (level/position). If True, the tier-rule-wait-second will be multiplied by the tier level and the caller will have to wait on every tier tier-rule-wait-second's before advancing to the next tier.";
