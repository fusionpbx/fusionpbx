<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "PCMU";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Paging Codec for named-parameter templates (GSC3516 etc). Values: PCMU, PCMA, G_726_32, G_722, iLBC, OPUS, G_723_1, G_729AOrB. Must match the sender (Yealink multicast keys, alarm panel). PCMU = universal compatibility.";
		$y++;
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.1:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 1 (highest) address. Default 239.0.1.1:5001 = EMERGENCY-ALL zone. When paging_barge=priority1 this overrides an active SIP call. Senders must hit this exact IP:port. Was 224.0.1.116:5001 (WP8xx PTT) - moved to admin-scoped 239.x.x.x range for clean zoning.";
		$y++;
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "EMERGENCY-ALL";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 1 label (shown on device web UI).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "41bde97a-b3c9-428e-8559-7af5e11abbf5";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_paging_barge";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "priority1";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Paging Barge threshold. Values: Disable | priority1 ... priority10. priority1 = a priority-1 multicast (EMERGENCY) hangs up an active SIP call; lower priorities defer to SIP. Disable = SIP always wins.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "05b05f53-ca78-46ce-8a55-450f0d6630d4";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_paging_priority_active";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "Yes";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Paging Priority Active. Values: No | Yes. Yes = a higher-priority incoming multicast interrupts a lower-priority page already playing (so EMERGENCY can cut into a regular all-call).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "d211fa1b-d7d7-40f1-95dd-3ab4bc7009b5";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_2";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.2:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 2 address. ALL-CALL zone (site-wide non-emergency page).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "7b672798-cee4-44f3-9245-e1e705c459d4";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_2";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "ALL-CALL";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 2 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "90f6aa52-4299-4eb7-91c5-1d03b7fe4bd7";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_3";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.10:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 3 address. FLOOR-1 zone. Subscribe only Floor 1 devices via Device Profile override.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "c06f7439-cad8-46ae-8119-fc3666401405";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_3";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "FLOOR-1";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 3 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "c25ae882-89d1-4980-9b2f-cee935c591b6";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_4";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.11:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 4 address. FLOOR-2 zone. Subscribe only Floor 2 devices.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "2b35a239-7406-4390-b2a6-44eeafd3b26e";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_4";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "FLOOR-2";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 4 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "8c4f5d52-db49-41d1-9771-bbc33c114b30";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_5";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.12:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 5 address. FLOOR-3 zone. Subscribe only Floor 3 devices.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "bf31f045-4d8f-41a0-b366-fd1f401e20c4";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_5";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "FLOOR-3";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 5 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "2c554f14-99ff-4aed-94b0-0c3016241997";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_6";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.20:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 6 address. CLASSROOMS-F1 sub-zone.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "dac6eb2a-9259-4382-8791-67674c463026";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_6";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "CLASSROOMS-F1";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 6 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "9ce25f3d-e8e4-4fcc-af4e-a59c0c630c41";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_7";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.21:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 7 address. CLASSROOMS-F2 sub-zone.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "91a5ac78-c385-4970-a86d-f672fa3c302b";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_7";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "CLASSROOMS-F2";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 7 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "a1f6b9d5-1ca0-4bc4-8ab4-079a564eeefb";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_8";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.22:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 8 address. CLASSROOMS-F3 sub-zone.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "d2d4eb44-8e5c-445a-bd42-5cc0ee26dfd6";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_8";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "CLASSROOMS-F3";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 8 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "67faf5bf-fa43-4179-abdd-b7bcf5036bd4";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_9";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.30:5001";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 9 address. RESERVED for future zone / ad-hoc use.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "4442f489-7942-4b18-8444-3e9ad54290a8";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_9";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "RESERVED";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 9 label.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "4e9e6a29-1b3d-4aab-b339-139ae374a45b";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_address_10";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "239.0.1.99:5004";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 10 address. BG-MUSIC (background music stream). Different port (5004) to avoid voice/music state conflicts on receivers.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "82f8299c-cd6a-4b87-ae82-d5db2136ac93";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "grandstream_multicast_listening_label_10";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "BG-MUSIC";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Multicast Listening - Priority 10 label.";
		$y++;
