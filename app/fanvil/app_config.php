<?php
	...
	//default settings
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server.domain.local/app/fanvil/resources/firmware";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		...
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "https://server2.domain.local/app/fanvil/resources/firmware";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "55e6f830-6a30-437d-ae3d-a42c877695ae";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_enable_predial";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "0";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Pre-dial buffer mode for Fanvil V-series phones. 0 = auto-dial as soon as a digit is pressed on the idle screen (Yealink-style \"Dial Now\" behavior, recommended). 1 = classic pre-dial buffer, requires Send/OK or off-hook to commit.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "aa53fa2e-9674-4a2c-88f4-2ceab60be429";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dial_by_pound";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "1";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Allow the # key to send the dialed digits immediately on Fanvil V-series. 1 = enabled, 0 = disabled.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "68ba48dd-6a94-42d0-9300-2179418c2efd";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dial_timeout";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "numeric";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "3";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Auto-send delay in seconds after the last digit is pressed when no dial-plan rule matches (Fanvil V-series). Firmware default is 10; 3 is much snappier.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "318508ec-1dbc-476f-833f-3768b38ef4cd";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dialplan_1";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "[2-9]11";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Fanvil V-series dial-plan rule #1 (auto-send when matched). Default: [2-9]11 (3-digit service codes 211/311/411/511/611/711/811/911 in one rule). Pattern syntax: x = any digit, [2-9] = digit range.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "7f7649c9-f0c2-4d80-be38-394e4e0bdcb9";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dialplan_2";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "1[2-9]xxxxxxxxx";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Fanvil V-series dial-plan rule #2 (auto-send when matched). Default: 1[2-9]xxxxxxxxx (US 1+10-digit long-distance).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "0fba9169-ff53-44c7-a5ab-5c00d85a6356";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dialplan_3";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "[2-9]xxxxxxxxx";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Fanvil V-series dial-plan rule #3 (auto-send when matched). Default: [2-9]xxxxxxxxx (US 10-digit local).";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "58177107-ac35-485c-84bc-1b5f12c7a1a8";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dialplan_4";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Fanvil V-series dial-plan rule #4 (auto-send when matched). Empty by default - set per-deployment for extensions (xxxx) or other site-specific patterns.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "836c0dd5-7e90-44b2-965f-4f16a4594db5";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "fanvil_dialplan_5";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
