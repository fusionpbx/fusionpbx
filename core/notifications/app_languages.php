...
$text['message-invalid_recipient']['pt-br'] = "Destinatário de notificações inválido";
...
$text['message-disclaimer']['pt-br'] = "<u>Divulgação</u>: A habilitação do projeto Notificações e o consentimento para a coleta <i>anônima</i> e <i>geral</i> de informações demográficas sobre o seu ambiente de instalação. As informações solicitadas consistem no seguinte: 1) versão FusionPBX, 2) versão PHP, 3) servidor web e versão, 4) versão switch de voz, 5) Tipo de banco de dados e versão, 6) plataforma de sistema operacional e versão, e 7) Endereço IP público. Se você não deseja que esta informação seja enviada, basta deixar Projeto Notificações desativado, e nenhuma informção será apresentada sobre o sistema.";
...
$text['message-demographics_submitted']['pt-br'] = "Informações Demográficas enviadas";
...
$text['message-demographics']['pt-br'] = "<u>Nota</u>: Para ajudar o projeto fusionPBX, nos ajude a solucionar o incidente compartilhando as informações demográficas.";
...
$text['label-project_notification_recipient']['pt-br'] = "Destinatário";
...
$text['label-project_news']['pt-br'] = "Novidades";
...
$text['description-project_security']['pt-br'] = "Receber notificações de atualizações de segurança.";
...
$text['description-project_releases']['pt-br'] = "Receber notificações sobre uma nova versão disponível para download.";
...
$text['description-project_events']['pt-br'] = "Receber notificações dobre treinamentos futuros, sobre o sistema e outros eventos.";
