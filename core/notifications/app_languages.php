...
$text['title-notifications']['uk'] = "Сповіщення";
...
$text['option-disabled']['pt-pt'] = "Inv�lido";
$text['option-disabled']['fr-fr'] = "Handicap�s";
...
$text['message-update']['es-cl'] = "Actualizaci�n Completada";
$text['message-update']['pt-pt'] = "Actualiza��o Efectuada";
...
$text['message-no_channels']['pt-pt'] = "N�o h� canais habilitados";
$text['message-no_channels']['fr-fr'] = "Pas de canaux activ�s";
...
$text['message-invalid_recipient']['es-cl'] = "Inv�lido destinatario de la notificaci�n";
$text['message-invalid_recipient']['pt-pt'] = "Inv�lido Notifica��o Destinat�rio";
$text['message-invalid_recipient']['fr-fr'] = "Notification invalide b�n�ficiaire";
...
$text['message-invalid_recipient']['uk'] = "Невірний  отримувач повідомлення";
...
$text['message-failed']['pt-pt'] = "Falha na atualiza��o - Contato com o suporte";
$text['message-failed']['fr-fr'] = "Mise � jour a �chou� - Contacter le support technique";
...
$text['message-failed']['uk'] = "Не вдалося оновити - зв'яжіться зі службою підтримки";
...
$text['message-disclaimer']['es-cl'] = "<u>Divulgaci�n</u>: Habilitaci�n del proyecto Notificaciones es el consentimiento a la recopilaci�n de <i>an�nimo</i> y <i>generales</i> la informaci�n demogr�fica sobre su entorno de instalaci�n. La informaci�n solicitada se compone de los siguientes: 1) FusionPBX versi�n, 2) la versi�n de PHP, 3) del servidor web y la versi�n 4) Versi�n conmutador de voz, 5) el tipo de base de datos y la versi�n 6) plataforma de sistema operativo y versi�n, y 7) IP p�blica direcci�n. Si usted no desea que esta informaci�n sea presentada, simplemente deje de Proyecto Notificaciones deshabilitado, y ninguna informaci�n se presentar� sobre su sistema.";
$text['message-disclaimer']['pt-pt'] = "<u>Divulga��o</u>: A habilita��o do projeto Notifica��es � o consentimento para a coleta de <i>an�nimo</i> e <i>geral</i> informa��es demogr�ficas sobre o seu ambiente de instala��o. As informa��es solicitadas consiste no seguinte: 1) vers�o FusionPBX, 2) vers�o PHP, 3) servidor web e vers�o, 4) vers�o interruptor de voz, 5) Tipo de banco de dados e vers�o, 6) plataforma de sistema operacional e vers�o, e 7) IP p�blico endere�o. Se voc� n�o deseja que esta informa��o ser submetida, basta deixar Projeto Notifica��es desativada, e nenhuma informa��o ser� apresentada sobre o sistema.";
$text['message-disclaimer']['fr-fr'] = "<u>Divulgation</u>: Activation des notifications projet est consentement � la collecte de <i>anonyme</i> et <i>g�n�rale</i> des informations d�mographiques sur l'environnement d'installation. Les informations demand�es se compose de ce qui suit: 1) FusionPBX version 2) version de PHP, 3) le serveur web et la version 4) Version commutateur vocal, 5) type de base de donn�es et la version 6) plate-forme de syst�me d'exploitation et sa version, et 7) IP publique adresse. Si vous ne souhaitez pas que cette information soit pr�sent�e, laissez simplement Notifications projet d�sactiv�, et aucune information ne sera soumis � votre syst�me.";
...
$text['message-demographics_submitted']['es-cl'] = "Demograf�a Enviado";
$text['message-demographics_submitted']['pt-pt'] = "Demografia Submetido";
$text['message-demographics_submitted']['fr-fr'] = "D�mographie Soumis";
...
$text['message-demographics_submitted']['uk'] = "Демографія відправленя";
...
$text['message-demographics']['es-cl'] = "<u>Nota</u>: Para ayudar al proyecto FusionPBX presentando la informaci�n demogr�fica descrita anteriormente sin necesidad de suscribirse a Project Notificaciones, haga ";
$text['message-demographics']['pt-pt'] = "<u>Nota</u>: Para ajudar o projeto FusionPBX, apresentando as informa��es demogr�ficas descrito acima sem a assinatura do Projeto Notifica��es, basta ";
...
$text['label-project_security']['es-cl'] = "Seguran�a";
$text['label-project_security']['pt-pt'] = "Seguran�a";
$text['label-project_security']['fr-fr'] = "S�curit�";
...
$text['label-project_releases']['pt-pt'] = "Lan�amentos";
$text['label-project_releases']['fr-fr'] = "Communiqu�s";
...
$text['label-project_notifications']['pt-pt'] = "Projeto Notifica��es";
...
$text['label-project_notification_recipient']['pt-pt'] = "Benefici�rio";
...
$text['label-project_notification_method']['es-cl'] = "M�todo";
$text['label-project_notification_method']['pt-pt'] = "M�todo";
$text['label-project_notification_method']['fr-fr'] = "M�thode";
...
$text['label-project_news']['pt-pt'] = "Not�cia";
$text['label-project_news']['fr-fr'] = "Nouvelles";
$text['label-project_news']['pt-br'] = "Notícia";
$text['label-project_news']['pl'] = "Aktualności";
$text['label-project_news']['uk'] = "Новини";
...
$text['label-project_events']['fr-fr'] = "�v�nements";
...
$text['header-notifications']['pt-pt'] = "Notifica��es";
...
$text['header-notifications']['uk'] = "Сповіщення";
...
$text['description-project_security']['pt-pt'] = "Receber notifica��es de atualiza��es de seguran�a.";
$text['description-project_security']['fr-fr'] = "Receber notifica��es de atualiza��es de seguran�a.";
...
$text['description-project_releases']['es-cl'] = "Reciba notificaciones cuando una nueva versi�n estable de FusionPBX se liberan y disponible para su descarga.";
$text['description-project_releases']['pt-pt'] = "Receba notifica��es quando nova vers�o est�vel do FusionPBX s�o liberados e dispon�veis para download.";
$text['description-project_releases']['fr-fr'] = "Recevez des alertes lorsque la nouvelle version stable de FusionPBX sont lib�r�s et disponibles pour le t�l�chargement.";
...
$text['description-project_notifications']['pt-pt'] = "Ativar notifica��es de projetos FusionPBX.";
$text['description-project_notifications']['fr-fr'] = "Ativar notifica��es de projetos FusionPBX.";
...
$text['description-project_notification_recipient']['es-cl'] = "Introduzca la deseada direcci�n de correo electr�nico del destinatario.";
$text['description-project_notification_recipient']['pt-pt'] = "Digite o endere�o de email desejado para o destinat�rio.";
$text['description-project_notification_recipient']['fr-fr'] = "Entrez l'adresse e-mail souhait�e pour le destinataire.";
...
$text['description-project_notification_method']['es-cl'] = "Seleccione el m�todo deseado de la comunicaci�n.";
$text['description-project_notification_method']['pt-pt'] = "Seleccione o m�todo desejado de comunica��o.";
$text['description-project_notification_method']['fr-fr'] = "S�lectionnez la m�thode souhait�e de communication.";
$text['description-project_notification_method']['pt-br'] = "Selecione o método desejado de comunicação";
$text['description-project_notification_method']['pl'] = "Wybierz  metodę komunikacji.";
...
$text['description-project_news']['es-cl'] = "Recibir notificaciones de noticias FusionPBX relacionadas e informaci�n general.";
$text['description-project_news']['pt-pt'] = "Receber notifica��es de not�cias e informa��es gerais FusionPBX relacionados.";
$text['description-project_news']['fr-fr'] = "Recevoir des notifications de nouvelles et d'information g�n�rale FusionPBX li�s.";
...
$text['description-project_events']['es-cl'] = "Recibir notificaciones de pr�ximas clases FusionPBX formaci�n, cabinas de convenciones y otros eventos relacionados con el proyecto.";
$text['description-project_events']['pt-pt'] = "Receber notifica��es de futuras aulas FusionPBX forma��o, cabines de conven��es e outros eventos relacionados ao projeto.";
$text['description-project_events']['fr-fr'] = "Recevoir des notifications de venir les classes FusionPBX de formation, des stands de congr�s et d'autres �v�nements li�s au projet.";
...
$text['description-notifications']['es-cl'] = "Definici�n de las preferencias de notificaci�n de la comunicaci�n relacionada con el proyecto FusionPBX y otras alertas del sistema local.";
$text['description-notifications']['pt-pt'] = "Definir prefer�ncias de notifica��o para a comunica��o relacionada com o projecto FusionPBX e outros alertas do sistema local.";
$text['description-notifications']['fr-fr'] = "Definici�n de las preferencias de notificaci�n de la comunicaci�n relacionada con el proyecto FusionPBX y otras alertas del sistema local.";
