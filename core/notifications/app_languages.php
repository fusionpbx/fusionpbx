...
$text['message-disclaimer']['zh-cn'] = "<u> 公开</u>：启用项目通知表示同意收集有关安装环境的<i>匿名</i>和<i>一般</i>统计信息。请求的信息包括：1）FusionPBX版本，2）PHP版本，3）web服务器和版本，4）语音交换机版本，5）数据库类型和版本，6）操作系统平台和版本，以及7）公共IP地址。如果您不希望提交此信息，只需禁用“项目通知”，系统将不会提交任何信息。";
...
$text['message-demographics_submitted']['zh-cn'] = "统计";
...
$text['message-demographics']['zh-cn'] = "<u>注释</u>: 要通过提交上述统计信息而不订阅项目通知来帮助FusionPBX项目";
...
$text['label-project_notification_method']['zh-cn'] = "措施";
...
$text['description-project_releases']['zh-cn'] = "当FusionPBX的新稳定版本发布并可供下载时，接收通知。";
...
$text['description-project_notification_recipient']['zh-cn'] = "输入收件人的电子邮件地址。";
...
$text['description-project_notification_method']['zh-cn'] = "选择通信方法。";
...
$text['description-project_events']['zh-cn'] = "接收即将到来的FusionPBX培训、会议以及与项目相关的其他活动的通知。";
...
$text['description-notifications']['zh-cn'] = "设置FusionPBX项目相关通信和其他本地系统警报的通知首选项。";
