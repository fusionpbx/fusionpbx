...
$z++;
		...
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'dashboard_background_color_edge';
		$apps[$x]['db'][$y]['fields'][$z]['type'] = 'text';
		$apps[$x]['db'][$y]['fields'][$z]['search_by'] = '';
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = 'Enter the gradient background color edge.';
		$z++;
		$apps[$x]['db'][$y]['fields'][$z]['name'] = 'dashboard_background_color_center';
		$apps[$x]['db'][$y]['fields'][$z]['type'] = 'text';
		$apps[$x]['db'][$y]['fields'][$z]['search_by'] = '';
		$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = 'Enter the gradient background color center.';
		$z++;
