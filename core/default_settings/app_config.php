<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "f72162a2-01a6-11e8-ba89-0ed5f89f718b";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "email";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "freeswitch_from";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "var";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "2f72165fe-01a6-11e8-ba89-0ed5f89f718b";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "email";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "freeswitch_from_name";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "var";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "";
