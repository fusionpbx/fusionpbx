<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "564affb1-8d57-4b06-a8ba-1183cb6f8f6c";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "dashboard";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "superadmin";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "caller_id";
		...
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Enable Dashboard Call Center Agent Status block for users in the agent group.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "18839f64-db73-4df5-ae15-f8da89fb38da";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "dashboard";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "admin";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "caller_id";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Enable admin control of Caller ID from the Dashboard.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "ac44e225-1ebc-473d-93c7-e72a7e0b59e5";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "dashboard";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "user";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "array";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "caller_id";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Enable user control of Caller ID from the Dashboard.";
		$y++;
