<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "38b9f4b5-6a2b-4257-a731-d0e95179af9e";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "login";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "passkey_enabled";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Display the Passkey button on the login form (requires a registered user passkey).";
		$y++;
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "d1a2b3c4-5e6f-4a7b-8c9d-0e1f2a3b4c5d";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "login";
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "e2b3c4d5-6f7a-4b8c-9d0e-1f2a3b4c5d6e";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "login";
		...
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "passkey_button_text_color";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "#434E5A";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Text color of the Sign in with a Passkey button on the login form.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "e5f6a7b8-9c0d-4e1f-b2c3-4d5e6f7a8b9c";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "theme";
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "c9d0e1f2-a3b4-4c5d-8e6f-1a2b3c4d5e6f";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "login";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "logo_enabled";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Display the logo on the login form.";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "d0e1f2a3-b4c5-4d6e-9f7a-2b3c4d5e6f7a";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "login";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "horizontal_rule_enabled";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "false";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Display a horizontal rule divider below the logo on the login form.";
		$y++;
