...
$text['label-theme']['en-us'] = "Theme";
$text['label-theme']['en-gb'] = "Theme";
$text['label-theme']['ar-eg'] = "السمة";
$text['label-theme']['de-at'] = "Design";
$text['label-theme']['de-ch'] = "Design";
$text['label-theme']['de-de'] = "Design";
$text['label-theme']['el-gr'] = "Θέμα";
$text['label-theme']['es-cl'] = "Tema";
$text['label-theme']['es-mx'] = "Tema";
$text['label-theme']['fr-ca'] = "Thème";
$text['label-theme']['fr-fr'] = "Thème";
$text['label-theme']['he-il'] = "עיצוב";
$text['label-theme']['it-it'] = "Tema";
$text['label-theme']['ka-ge'] = "თემა";
$text['label-theme']['nl-nl'] = "Thema";
$text['label-theme']['pl-pl'] = "Motyw";
$text['label-theme']['pt-br'] = "Tema";
$text['label-theme']['pt-pt'] = "Tema";
$text['label-theme']['ro-ro'] = "Temă";
$text['label-theme']['ru-ru'] = "Тема";
$text['label-theme']['sv-se'] = "Tema";
$text['label-theme']['uk-ua'] = "Тема";
$text['label-theme']['zh-cn'] = "主题";
$text['label-theme']['ja-jp'] = "テーマ";
$text['label-theme']['ko-kr'] = "테마";

$text['description-theme']['en-us'] = "Select a theme.";
$text['description-theme']['en-gb'] = "Select a theme.";
$text['description-theme']['ar-eg'] = "اختر سمة.";
$text['description-theme']['de-at'] = "Wählen Sie ein Design.";
$text['description-theme']['de-ch'] = "Wählen Sie ein Design.";
$text['description-theme']['de-de'] = "Wählen Sie ein Design.";
$text['description-theme']['el-gr'] = "Επιλέξτε ένα θέμα.";
$text['description-theme']['es-cl'] = "Seleccione un tema.";
$text['description-theme']['es-mx'] = "Seleccione un tema.";
$text['description-theme']['fr-ca'] = "Sélectionnez un thème.";
$text['description-theme']['fr-fr'] = "Sélectionnez un thème.";
$text['description-theme']['he-il'] = "בחרו עיצוב.";
$text['description-theme']['it-it'] = "Seleziona un tema.";
$text['description-theme']['ka-ge'] = "აირჩიეთ თემა.";
$text['description-theme']['nl-nl'] = "Selecteer een thema.";
$text['description-theme']['pl-pl'] = "Wybierz motyw.";
$text['description-theme']['pt-br'] = "Selecione um tema.";
$text['description-theme']['pt-pt'] = "Selecione um tema.";
$text['description-theme']['ro-ro'] = "Selectați o temă.";
$text['description-theme']['ru-ru'] = "Выберите тему.";
$text['description-theme']['sv-se'] = "Välj ett tema.";
$text['description-theme']['uk-ua'] = "Оберіть тему.";
$text['description-theme']['zh-cn'] = "选择一个主题。";
$text['description-theme']['ja-jp'] = "テーマを選択してください。";
$text['description-theme']['ko-kr'] = "테마를 선택하세요.";

$text['label-user_passkey']['en-us'] = "Passkey";
$text['label-user_passkey']['en-gb'] = "Passkey";
$text['label-user_passkey']['ar-eg'] = "مفتاح المرور";
$text['label-user_passkey']['de-at'] = "Passkey";
$text['label-user_passkey']['de-ch'] = "Passkey";
$text['label-user_passkey']['de-de'] = "Passkey";
$text['label-user_passkey']['el-gr'] = "Κωδικός εισόδου";
$text['label-user_passkey']['es-cl'] = "Clave de acceso";
$text['label-user_passkey']['es-mx'] = "Clave de acceso";
$text['label-user_passkey']['fr-ca'] = "Clé de passage";
$text['label-user_passkey']['fr-fr'] = "Clé de passage";
$text['label-user_passkey']['he-il'] = "מפתח כניסה";
$text['label-user_passkey']['it-it'] = "Chiave di accesso";
$text['label-user_passkey']['ka-ge'] = "შესვლის საკლავი";
$text['label-user_passkey']['nl-nl'] = "Toegangssleutel";
$text['label-user_passkey']['pl-pl'] = "Klucz dostępu";
$text['label-user_passkey']['pt-br'] = "Chave de acesso";
$text['label-user_passkey']['pt-pt'] = "Chave de acesso";
$text['label-user_passkey']['ro-ro'] = "Cheie de acces";
$text['label-user_passkey']['ru-ru'] = "Ключ доступа";
$text['label-user_passkey']['sv-se'] = "Tillträdesnyckel";
$text['label-user_passkey']['uk-ua'] = "Ключ доступу";
$text['label-user_passkey']['tr-tr'] = "Geçiş anahtarı";
$text['label-user_passkey']['zh-cn'] = "通行密钥";
$text['label-user_passkey']['ja-jp'] = "パスキー";
$text['label-user_passkey']['ko-kr'] = "패스키";

$text['description-user_passkey']['en-us'] = "Passkeys let you sign in with a security key, fingerprint, face or your device (iPhone, iPad, Android).";
$text['description-user_passkey']['en-gb'] = "Passkeys let you sign in with a security key, fingerprint, face or your device (iPhone, iPad, Android).";
$text['description-user_passkey']['ar-eg'] = "تتيح لك مفاتيح الدخول تسجيل الدخول باستخدام مفتاح أمان أو بصمة الإصبع أو الوجه أو جهازك (iPhone أو iPad أو Android).";
$text['description-user_passkey']['de-at'] = "Passkeys ermöglichen es dir, dich mit einem Sicherheitsschlüssel, Fingerabdruck, Gesicht oder deinem Gerät (iPhone, iPad, Android) anzumelden.";
$text['description-user_passkey']['de-ch'] = "Passkeys ermöglichen es dir, dich mit einem Sicherheitsschlüssel, Fingerabdruck, Gesicht oder deinem Gerät (iPhone, iPad, Android) anzumelden.";
$text['description-user_passkey']['de-de'] = "Passkeys ermöglichen es dir, dich mit einem Sicherheitsschlüssel, Fingerabdruck, Gesicht oder deinem Gerät (iPhone, iPad, Android) anzumelden.";
$text['description-user_passkey']['el-gr'] = "Οι Passkeys σας επιτρέπουν να κάνετε είσοδο με κλειδί ασφαλείας, αποτύπωμα δακτύλου, πρόσωπο ή τη συσκευή σας (iPhone, iPad, Android).";
$text['description-user_passkey']['es-cl'] = "Las passkeys te permiten iniciar sesión con una clave de seguridad, huella dactilar, rostro o tu dispositivo (iPhone, iPad, Android).";
$text['description-user_passkey']['es-mx'] = "Las passkeys te permiten iniciar sesión con una clave de seguridad, huella dactilar, rostro o tu dispositivo (iPhone, iPad, Android).";
$text['description-user_passkey']['fr-ca'] = "Les passkeys vous permettent de vous connecter avec une clé de sécurité, une empreinte digitale, votre visage ou votre appareil (iPhone, iPad, Android).";
$text['description-user_passkey']['fr-fr'] = "Les passkeys vous permettent de vous connecter avec une clé de sécurité, une empreinte digitale, votre visage ou votre appareil (iPhone, iPad, Android).";
$text['description-user_passkey']['he-il'] = "מפתחות ההתחברות מאפשרים לכם להתחבר באמצעות מפתח אבטחה, טביעת אצבע, פנים או המכשיר שלכם (iPhone, iPad, Android).";
$text['description-user_passkey']['it-it'] = "Le passkeys ti consentono di accedere con una chiave di sicurezza, un'impronta digitale, il volto o il tuo dispositivo (iPhone, iPad, Android).";
$text['description-user_passkey']['ka-ge'] = "Passkeys-ი საშუალებას გძლევთ შესვლას უსაფრთხოების გასაღდით, თითის აბეგვრით, სახით ან თქვენს მოწყობილობაზე (iPhone, iPad, Android).";
$text['description-user_passkey']['nl-nl'] = "Met passkeys kun je inloggen met een beveiligingssleutel, vingerafdruk, gezicht of je apparaat (iPhone, iPad, Android).";
$text['description-user_passkey']['pl-pl'] = "Passkeys pozwalają Ci się zalogować za pomocą klucza bezpieczeństwa, odcisku palca, twarzy lub Twojego urządzenia (iPhone, iPad, Android).";
$text['description-user_passkey']['pt-br'] = "As passkeys permitem que você faça login com uma chave de segurança, impressão digital, rosto ou seu dispositivo (iPhone, iPad, Android).";
$text['description-user_passkey']['pt-pt'] = "As passkeys permitem-lhe iniciar sessão com uma chave de segurança, uma impressão digital, o rosto ou o seu dispositivo (iPhone, iPad, Android).";
$text['description-user_passkey']['ro-ro'] = "Passkeys vă permit să vă autentificați cu o cheie de securitate, amprentă digitală, fața sau dispozitivul dvs. (iPhone, iPad, Android).";
$text['description-user_passkey']['ru-ru'] = "Passkeys позволяют вам входить в систему с помощью ключа безопасности, отпечатка пальца, лица или вашего устройства (iPhone, iPad, Android).";
$text['description-user_passkey']['sv-se'] = "Passkeys låter dig logga in med en säkerhetsnyckel, fingeravtryck, ansikte eller din enhet (iPhone, iPad, Android).";
$text['description-user_passkey']['uk-ua'] = "Passkeys дають вам можливість входу за допомогою ключа безпеки, відбитка пальця, обличчя або вашого пристрою (iPhone, iPad, Android).";
$text['description-user_passkey']['tr-tr'] = "Passkeys, bir güvenlik anahtarı, parmak izi, yüz veya cihazınızla (iPhone, iPad, Android) giriş yapmanızı sağlar.";
$text['description-user_passkey']['zh-cn'] = "通行密钥可让您通过安全密钥、指纹、面容或设备（iPhone、iPad、Android）登录。";
$text['description-user_passkey']['ja-jp'] = "Passkeysを使用すると、セキュリティキー、指紋、顔、またはデバイス（iPhone、iPad、Android）でサインインできます。";
$text['description-user_passkey']['ko-kr'] = "패스키를 사용하면 보안 키, 지문, 얼굴 또는 기기(iPhone, iPad, Android)로 로그인할 수 있습니다.";

$text['description-user_passkey_none']['en-us'] = "No passkeys registered for this user.";
$text['description-user_passkey_none']['en-gb'] = "No passkeys registered for this user.";
$text['description-user_passkey_none']['ar-eg'] = "لا توجد مفاتيح مرور مسجلة لهذا المستخدم.";
$text['description-user_passkey_none']['de-at'] = "Keine Passkeys für diesen Benutzer registriert.";
$text['description-user_passkey_none']['de-ch'] = "Keine Passkeys für diesen Benutzer registriert.";
$text['description-user_passkey_none']['de-de'] = "Keine Passkeys für diesen Benutzer registriert.";
$text['description-user_passkey_none']['el-gr'] = "Δεν υπάρχουν καταχωρημένα passkeys για αυτόν τον χρήστη.";
$text['description-user_passkey_none']['es-cl'] = "No hay passkeys registrados para este usuario.";
$text['description-user_passkey_none']['es-mx'] = "No hay passkeys registrados para este usuario.";
$text['description-user_passkey_none']['fr-ca'] = "Aucun passkey n'est enregistré pour cet utilisateur.";
$text['description-user_passkey_none']['fr-fr'] = "Aucun passkey n'est enregistré pour cet utilisateur.";
$text['description-user_passkey_none']['he-il'] = "אין passkeys שנרשמו למשתמש זה.";
$text['description-user_passkey_none']['it-it'] = "Nessun passkey registrato per questo utente.";
$text['description-user_passkey_none']['ka-ge'] = "ამომხმარებელს არ აქვს რეგისტრირებული passkey-ები.";
$text['description-user_passkey_none']['nl-nl'] = "Er zijn geen passkeys geregistreerd voor deze gebruiker.";
$text['description-user_passkey_none']['pl-pl'] = "Nie zarejestrowano żadnego passkey dla tego użytkownika.";
$text['description-user_passkey_none']['pt-br'] = "Nenhum passkey registrado para este usuário.";
$text['description-user_passkey_none']['pt-pt'] = "Nenhum passkey registado para este utilizador.";
$text['description-user_passkey_none']['ro-ro'] = "Nu există niciun passkey înregistrat pentru acest utilizator.";
$text['description-user_passkey_none']['ru-ru'] = "Для этого пользователя не зарегистрировано ни одного passkey.";
$text['description-user_passkey_none']['sv-se'] = "Inga passkeys registrerade för denna användare.";
$text['description-user_passkey_none']['uk-ua'] = "Немає passkey, зареєстрованих для цього користувача.";
$text['description-user_passkey_none']['tr-tr'] = "Bu kullanıcı için kayıtlı hiçbir passkey yok.";
$text['description-user_passkey_none']['zh-cn'] = "该用户没有注册任何通行密钥。";
$text['description-user_passkey_none']['ja-jp'] = "このユーザーには登録されたパスキーがありません。";
$text['description-user_passkey_none']['ko-kr'] = "이 사용자에게 등록되어 있는 패스키가 없습니다.";

$text['button-passkey_register']['en-us'] = "Register passkey";
$text['button-passkey_register']['en-gb'] = "Register passkey";
$text['button-passkey_register']['ar-eg'] = "تسجيل مفتاح الدخول";
...
$text['button-passkey_delete']['en-us'] = "Delete";
$text['button-passkey_delete']['en-gb'] = "Delete";
$text['button-passkey_delete']['ar-eg'] = "حذف";
$text['button-passkey_delete']['de-at'] = "Löschen";
$text['button-passkey_delete']['de-ch'] = "Löschen";
$text['button-passkey_delete']['de-de'] = "Löschen";
$text['button-passkey_delete']['el-gr'] = "Διαγραφή";
$text['button-passkey_delete']['es-cl'] = "Eliminar";
$text['button-passkey_delete']['es-mx'] = "Eliminar";
$text['button-passkey_delete']['fr-ca'] = "Supprimer";
$text['button-passkey_delete']['fr-fr'] = "Supprimer";
$text['button-passkey_delete']['he-il'] = "מחיקה";
$text['button-passkey_delete']['it-it'] = "Elimina";
$text['button-passkey_delete']['ka-ge'] = "წაშლა";
$text['button-passkey_delete']['nl-nl'] = "Verwijderen";
$text['button-passkey_delete']['pl-pl'] = "Usuń";
$text['button-passkey_delete']['pt-br'] = "Excluir";
$text['button-passkey_delete']['pt-pt'] = "Eliminar";
$text['button-passkey_delete']['ro-ro'] = "Ștergere";
$text['button-passkey_delete']['ru-ru'] = "Удалить";
$text['button-passkey_delete']['sv-se'] = "Ta bort";
$text['button-passkey_delete']['uk-ua'] = "Видалити";
$text['button-passkey_delete']['tr-tr'] = "Sil";
$text['button-passkey_delete']['zh-cn'] = "删除";
$text['button-passkey_delete']['ja-jp'] = "削除";
$text['button-passkey_delete']['ko-kr'] = "삭제";

$text['button-passkey_edit']['en-us'] = "Edit";
$text['button-passkey_edit']['en-gb'] = "Edit";
$text['button-passkey_edit']['ar-eg'] = "";
$text['button-passkey_edit']['de-at'] = "";
$text['button-passkey_edit']['de-ch'] = "";
$text['button-passkey_edit']['de-de'] = "";
$text['button-passkey_edit']['el-gr'] = "";
$text['button-passkey_edit']['es-cl'] = "";
$text['button-passkey_edit']['es-mx'] = "";
$text['button-passkey_edit']['fr-ca'] = "";
$text['button-passkey_edit']['fr-fr'] = "";
$text['button-passkey_edit']['he-il'] = "";
$text['button-passkey_edit']['it-it'] = "";
$text['button-passkey_edit']['ka-ge'] = "";
$text['button-passkey_edit']['nl-nl'] = "";
$text['button-passkey_edit']['pl-pl'] = "";
$text['button-passkey_edit']['pt-br'] = "";
$text['button-passkey_edit']['pt-pt'] = "";
$text['button-passkey_edit']['ro-ro'] = "";
$text['button-passkey_edit']['ru-ru'] = "";
$text['button-passkey_edit']['sv-se'] = "";
$text['button-passkey_edit']['uk-ua'] = "";
$text['button-passkey_edit']['tr-tr'] = "";
$text['button-passkey_edit']['zh-cn'] = "";
$text['button-passkey_edit']['ja-jp'] = "";
$text['button-passkey_edit']['ko-kr'] = "";

$text['button-passkey_save']['en-us'] = "Save";
$text['button-passkey_save']['en-gb'] = "Save";
$text['button-passkey_save']['ar-eg'] = "";
$text['button-passkey_save']['de-at'] = "";
$text['button-passkey_save']['de-ch'] = "";
$text['button-passkey_save']['de-de'] = "";
$text['button-passkey_save']['el-gr'] = "";
$text['button-passkey_save']['es-cl'] = "";
$text['button-passkey_save']['es-mx'] = "";
$text['button-passkey_save']['fr-ca'] = "";
$text['button-passkey_save']['fr-fr'] = "";
$text['button-passkey_save']['he-il'] = "";
$text['button-passkey_save']['it-it'] = "";
$text['button-passkey_save']['ka-ge'] = "";
$text['button-passkey_save']['nl-nl'] = "";
$text['button-passkey_save']['pl-pl'] = "";
$text['button-passkey_save']['pt-br'] = "";
$text['button-passkey_save']['pt-pt'] = "";
$text['button-passkey_save']['ro-ro'] = "";
$text['button-passkey_save']['ru-ru'] = "";
$text['button-passkey_save']['sv-se'] = "";
$text['button-passkey_save']['uk-ua'] = "";
$text['button-passkey_save']['tr-tr'] = "";
$text['button-passkey_save']['zh-cn'] = "";
$text['button-passkey_save']['ja-jp'] = "";
$text['button-passkey_save']['ko-kr'] = "";

$text['button-passkey_cancel']['en-us'] = "Cancel";
$text['button-passkey_cancel']['en-gb'] = "Cancel";
$text['button-passkey_cancel']['ar-eg'] = "";
$text['button-passkey_cancel']['de-at'] = "";
$text['button-passkey_cancel']['de-ch'] = "";
$text['button-passkey_cancel']['de-de'] = "";
$text['button-passkey_cancel']['el-gr'] = "";
$text['button-passkey_cancel']['es-cl'] = "";
$text['button-passkey_cancel']['es-mx'] = "";
$text['button-passkey_cancel']['fr-ca'] = "";
$text['button-passkey_cancel']['fr-fr'] = "";
$text['button-passkey_cancel']['he-il'] = "";
$text['button-passkey_cancel']['it-it'] = "";
$text['button-passkey_cancel']['ka-ge'] = "";
$text['button-passkey_cancel']['nl-nl'] = "";
$text['button-passkey_cancel']['pl-pl'] = "";
$text['button-passkey_cancel']['pt-br'] = "";
$text['button-passkey_cancel']['pt-pt'] = "";
$text['button-passkey_cancel']['ro-ro'] = "";
$text['button-passkey_cancel']['ru-ru'] = "";
$text['button-passkey_cancel']['sv-se'] = "";
$text['button-passkey_cancel']['uk-ua'] = "";
$text['button-passkey_cancel']['tr-tr'] = "";
$text['button-passkey_cancel']['zh-cn'] = "";
$text['button-passkey_cancel']['ja-jp'] = "";
$text['button-passkey_cancel']['ko-kr'] = "";

$text['message-passkey_renamed']['en-us'] = "Passkey renamed.";
$text['message-passkey_renamed']['en-gb'] = "Passkey renamed.";
$text['message-passkey_renamed']['ar-eg'] = "";
$text['message-passkey_renamed']['de-at'] = "";
$text['message-passkey_renamed']['de-ch'] = "";
$text['message-passkey_renamed']['de-de'] = "";
$text['message-passkey_renamed']['el-gr'] = "";
$text['message-passkey_renamed']['es-cl'] = "";
$text['message-passkey_renamed']['es-mx'] = "";
$text['message-passkey_renamed']['fr-ca'] = "";
$text['message-passkey_renamed']['fr-fr'] = "";
$text['message-passkey_renamed']['he-il'] = "";
$text['message-passkey_renamed']['it-it'] = "";
$text['message-passkey_renamed']['ka-ge'] = "";
$text['message-passkey_renamed']['nl-nl'] = "";
$text['message-passkey_renamed']['pl-pl'] = "";
$text['message-passkey_renamed']['pt-br'] = "";
$text['message-passkey_renamed']['pt-pt'] = "";
$text['message-passkey_renamed']['ro-ro'] = "";
$text['message-passkey_renamed']['ru-ru'] = "";
$text['message-passkey_renamed']['sv-se'] = "";
$text['message-passkey_renamed']['uk-ua'] = "";
$text['message-passkey_renamed']['tr-tr'] = "";
$text['message-passkey_renamed']['zh-cn'] = "";
$text['message-passkey_renamed']['ja-jp'] = "";
$text['message-passkey_renamed']['ko-kr'] = "";

$text['message-passkey_rename_failed']['en-us'] = "Passkey rename failed, please try again.";
$text['message-passkey_rename_failed']['en-gb'] = "Passkey rename failed, please try again.";
$text['message-passkey_rename_failed']['ar-eg'] = "";
$text['message-passkey_rename_failed']['de-at'] = "";
$text['message-passkey_rename_failed']['de-ch'] = "";
$text['message-passkey_rename_failed']['de-de'] = "";
$text['message-passkey_rename_failed']['el-gr'] = "";
$text['message-passkey_rename_failed']['es-cl'] = "";
$text['message-passkey_rename_failed']['es-mx'] = "";
$text['message-passkey_rename_failed']['fr-ca'] = "";
$text['message-passkey_rename_failed']['fr-fr'] = "";
$text['message-passkey_rename_failed']['he-il'] = "";
$text['message-passkey_rename_failed']['it-it'] = "";
$text['message-passkey_rename_failed']['ka-ge'] = "";
$text['message-passkey_rename_failed']['nl-nl'] = "";
$text['message-passkey_rename_failed']['pl-pl'] = "";
$text['message-passkey_rename_failed']['pt-br'] = "";
$text['message-passkey_rename_failed']['pt-pt'] = "";
$text['message-passkey_rename_failed']['ro-ro'] = "";
$text['message-passkey_rename_failed']['ru-ru'] = "";
$text['message-passkey_rename_failed']['sv-se'] = "";
$text['message-passkey_rename_failed']['uk-ua'] = "";
$text['message-passkey_rename_failed']['tr-tr'] = "";
$text['message-passkey_rename_failed']['zh-cn'] = "";
$text['message-passkey_rename_failed']['ja-jp'] = "";
$text['message-passkey_rename_failed']['ko-kr'] = "";

$text['button-passkey_reset']['en-us'] = "Reset passkeys";
$text['button-passkey_reset']['en-gb'] = "Reset passkeys";
$text['button-passkey_reset']['ar-eg'] = "إعادة تعيين مفاتيح المرور";
$text['button-passkey_reset']['de-at'] = "Passkeys zurücksetzen";
$text['button-passkey_reset']['de-ch'] = "Passkeys zurücksetzen";
$text['button-passkey_reset']['de-de'] = "Passkeys zurücksetzen";
$text['button-passkey_reset']['el-gr'] = "Επαναφορά κλειδιών πέρασης";
$text['button-passkey_reset']['es-cl'] = "Restablecer claves de acceso";
$text['button-passkey_reset']['es-mx'] = "Restablecer claves de acceso";
$text['button-passkey_reset']['fr-ca'] = "Réinitialiser les clés d'accès";
$text['button-passkey_reset']['fr-fr'] = "Réinitialiser les clés d'accès";
$text['button-passkey_reset']['he-il'] = "איפוס מפתחות ההזדהות";
$text['button-passkey_reset']['it-it'] = "Reimposta chiavi di accesso";
$text['button-passkey_reset']['ka-ge'] = "გადატვირთვა გასაღებების";
$text['button-passkey_reset']['nl-nl'] = "Passkeys wissen";
$text['button-passkey_reset']['pl-pl'] = "Wyzeruj klucze dostępu";
$text['button-passkey_reset']['pt-br'] = "Redefinir chaves de acesso";
$text['button-passkey_reset']['pt-pt'] = "Repor chaves de acesso";
$text['button-passkey_reset']['ro-ro'] = "Resetează cheile de acces";
$text['button-passkey_reset']['ru-ru'] = "Сбросить ключи доступа";
$text['button-passkey_reset']['sv-se'] = "Återställ passnycklar";
$text['button-passkey_reset']['uk-ua'] = "Скинути ключі доступу";
$text['button-passkey_reset']['tr-tr'] = "Geçiş anahtarlarını sıfırla";
$text['button-passkey_reset']['zh-cn'] = "重置通行密钥";
$text['button-passkey_reset']['ja-jp'] = "パスキーをリセット";
$text['button-passkey_reset']['ko-kr'] = "패스키 재설정";

$text['message-passkey_registered']['en-us'] = "Passkey registered.";
$text['message-passkey_registered']['en-gb'] = "Passkey registered.";
$text['message-passkey_registered']['ar-eg'] = "تم تسجيل مفتاح المرور.";
$text['message-passkey_registered']['de-at'] = "Passkey registriert.";
$text['message-passkey_registered']['de-ch'] = "Passkey registriert.";
$text['message-passkey_registered']['de-de'] = "Passkey registriert.";
$text['message-passkey_registered']['el-gr'] = "Το passkey καταχωρήθηκε.";
$text['message-passkey_registered']['es-cl'] = "Clave de acceso registrada.";
$text['message-passkey_registered']['es-mx'] = "Clave de acceso registrada.";
$text['message-passkey_registered']['fr-ca'] = "Clé d'accès enregistrée.";
$text['message-passkey_registered']['fr-fr'] = "Clé d'accès enregistrée.";
$text['message-passkey_registered']['he-il'] = "מפתח הגעה נרשם.";
$text['message-passkey_registered']['it-it'] = "Classe di accesso registrata.";
$text['message-passkey_registered']['ka-ge'] = "Passkey დარეგისტრირდა.";
$text['message-passkey_registered']['nl-nl'] = "Toegangssleutel geregistreerd.";
$text['message-passkey_registered']['pl-pl'] = "Klucz dostępu zarejestrowany.";
$text['message-passkey_registered']['pt-br'] = "Chave de acesso registrada.";
$text['message-passkey_registered']['pt-pt'] = "Chave de acesso registada.";
$text['message-passkey_registered']['ro-ro'] = "Cheia de acces înregistrată.";
$text['message-passkey_registered']['ru-ru'] = "Ключ доступа зарегистрирован.";
$text['message-passkey_registered']['sv-se'] = "Åtkomstnyckel registrerad.";
$text['message-passkey_registered']['uk-ua'] = "Ключ доступу зареєстровано.";
$text['message-passkey_registered']['tr-tr'] = "Geçiş anahtarı kaydedildi.";
$text['message-passkey_registered']['zh-cn'] = "通行密钥已注册。";
$text['message-passkey_registered']['ja-jp'] = "パスキーが登録されました。";
$text['message-passkey_registered']['ko-kr'] = "패스키가 등록되었습니다.";
...
$text['message-passkey_registration_failed']['de-at'] = "Die Passkey-Registrierung ist fehlgeschlagen. Bitte versuchen Sie es erneut.";
$text['message-passkey_registration_failed']['de-ch'] = "Die Passkey-Registrierung ist fehlgeschlagen. Bitte versuchen Sie es erneut.";
$text['message-passkey_registration_failed']['de-de'] = "Die Passkey-Registrierung ist fehlgeschlagen. Bitte versuchen Sie es erneut.";
$text['message-passkey_registration_failed']['el-gr'] = "Η εγγραφή του Passkey απέτυχε, παρακαλώ προσπαθήστε ξανά.";
$text['message-passkey_registration_failed']['es-cl'] = "El registro de Passkey falló, por favor inténtelo de nuevo.";
$text['message-passkey_registration_failed']['es-mx'] = "El registro de Passkey falló, por favor inténtalo de nuevo.";
...
$text['message-passkey_registration_failed']['he-il'] = "הרשמת Passkey נכשלה, אנא נסו שוב.";
$text['message-passkey_registration_failed']['it-it'] = "La registrazione del Passkey non è riuscita, riprova.";
$text['message-passkey_registration_failed']['ka-ge'] = "Passkey-ის დარეგისტრირება ვერ მოხერხდა, გთხოვთ თავიდან სცადოთ.";
...
$text['message-passkey_registration_failed']['pt-br'] = "Falha no registro do Passkey, tente novamente.";
$text['message-passkey_registration_failed']['pt-pt'] = "O registo do Passkey falhou, por favor tente novamente.";
$text['message-passkey_registration_failed']['ro-ro'] = "Înregistrarea Passkey a eșuat, vă rugăm să încercați din nou.";
$text['message-passkey_registration_failed']['ru-ru'] = "Не удалось зарегистрировать Passkey, попробуйте снова.";
$text['message-passkey_registration_failed']['sv-se'] = "Registreringen av Passkey misslyckades, försök igen.";
$text['message-passkey_registration_failed']['uk-ua'] = "Реєстрацію Passkey не вдалося завершити, спробуйте ще раз.";
$text['message-passkey_registration_failed']['tr-tr'] = "Passkey kaydı başarısız oldu, lütfen tekrar deneyin.";
$text['message-passkey_registration_failed']['zh-cn'] = "Passkey 注册失败，请重试。";
$text['message-passkey_registration_failed']['ja-jp'] = "Passkey の登録に失敗しました。もう一度お試しください。";
$text['message-passkey_registration_failed']['ko-kr'] = "Passkey 등록에 실패했습니다. 다시 시도해 주세요.";

$text['message-passkey_deleted']['en-us'] = "Passkey deleted.";
$text['message-passkey_deleted']['en-gb'] = "Passkey deleted.";
$text['message-passkey_deleted']['ar-eg'] = "تم حذف مفتاح المرور.";
$text['message-passkey_deleted']['de-at'] = "Passkey gelöscht.";
$text['message-passkey_deleted']['de-ch'] = "Passkey gelöscht.";
$text['message-passkey_deleted']['de-de'] = "Passkey gelöscht.";
$text['message-passkey_deleted']['el-gr'] = "Το κλειδί πρόσβασης διαγράφηκε.";
$text['message-passkey_deleted']['es-cl'] = "Clave de acceso eliminada.";
$text['message-passkey_deleted']['es-mx'] = "Clave de acceso eliminada.";
$text['message-passkey_deleted']['fr-ca'] = "Passkey supprimé.";
$text['message-passkey_deleted']['fr-fr'] = "Passkey supprimé.";
$text['message-passkey_deleted']['he-il'] = "מפתח הגישה נמחק.";
$text['message-passkey_deleted']['it-it'] = "Chiave di accesso eliminata.";
$text['message-passkey_deleted']['ka-ge'] = "წვდომის გასამრთველი წაიშალა.";
$text['message-passkey_deleted']['nl-nl'] = "Toegangssleutel verwijderd.";
$text['message-passkey_deleted']['pl-pl'] = "Klucz dostępu usunięty.";
$text['message-passkey_deleted']['pt-br'] = "Chave de acesso excluída.";
$text['message-passkey_deleted']['pt-pt'] = "Chave de acesso eliminada.";
$text['message-passkey_deleted']['ro-ro'] = "Cheia de acces a fost ștearsă.";
$text['message-passkey_deleted']['ru-ru'] = "Ключ доступа удалён.";
$text['message-passkey_deleted']['sv-se'] = "Åtkomstnyckel borttagen.";
$text['message-passkey_deleted']['uk-ua'] = "Ключ доступу видалено.";
$text['message-passkey_deleted']['tr-tr'] = "Erişim anahtarı silindi.";
$text['message-passkey_deleted']['zh-cn'] = "通行密钥已删除。";
$text['message-passkey_deleted']['ja-jp'] = "パスキーが削除されました。";
$text['message-passkey_deleted']['ko-kr'] = "패스키가 삭제되었습니다.";

$text['message-passkey_delete_failed']['en-us'] = "Passkey deletion failed, please try again.";
$text['message-passkey_delete_failed']['en-gb'] = "Passkey deletion failed, please try again.";
$text['message-passkey_delete_failed']['ar-eg'] = "فشل حذف المفتاح الموثوق، يرجى المحاولة مرة أخرى.";
$text['message-passkey_delete_failed']['de-at'] = "Das Löschen des Passkeys ist fehlgeschlagen. Bitte versuchen Sie es erneut.";
$text['message-passkey_delete_failed']['de-ch'] = "Das Löschen des Passkeys ist fehlgeschlagen. Bitte versuchen Sie es erneut.";
$text['message-passkey_delete_failed']['de-de'] = "Das Löschen des Passkeys ist fehlgeschlagen. Bitte versuchen Sie es erneut.";
$text['message-passkey_delete_failed']['el-gr'] = "Απέτυχε η διαγραφή του πέρασματος. Προσπαθήστε ξανά.";
$text['message-passkey_delete_failed']['es-cl'] = "La eliminación de la clave de acceso falló. Inténtalo de nuevo.";
$text['message-passkey_delete_failed']['es-mx'] = "La eliminación de la clave de acceso falló. Inténtalo de nuevo.";
$text['message-passkey_delete_failed']['fr-ca'] = "La suppression du passkey a échoué. Veuillez réessayer.";
$text['message-passkey_delete_failed']['fr-fr'] = "La suppression du passkey a échoué. Veuillez réessayer.";
$text['message-passkey_delete_failed']['he-il'] = "מחיקת מפתח העמידה נכשלה. נא לנסות שוב.";
$text['message-passkey_delete_failed']['it-it'] = "L'eliminazione del passkey non è riuscita. Riprova.";
$text['message-passkey_delete_failed']['ka-ge'] = "პასკის წაშლა ვერ მოხერხდა. შეეცადეთ ხელახლა.";
$text['message-passkey_delete_failed']['nl-nl'] = "Het verwijderen van de passkey is mislukt. Probeer het opnieuw.";
$text['message-passkey_delete_failed']['pl-pl'] = "Usunięcie passkey nie powiodło się. Spróbuj ponownie.";
$text['message-passkey_delete_failed']['pt-br'] = "A exclusão do passkey falhou. Tente novamente.";
$text['message-passkey_delete_failed']['pt-pt'] = "A eliminação do passkey falhou. Tente novamente.";
$text['message-passkey_delete_failed']['ro-ro'] = "Ștergerea passkey a eșuat. Încercați din nou.";
$text['message-passkey_delete_failed']['ru-ru'] = "Ошибка удаления ключа доступа. Повторите попытку.";
$text['message-passkey_delete_failed']['sv-se'] = "Raderingen av passkey misslyckades. Försök igen.";
$text['message-passkey_delete_failed']['uk-ua'] = "Видалення passkey не вдалося. Спробуйте ще раз.";
$text['message-passkey_delete_failed']['tr-tr'] = "Geçit anahtarı silinemedi, lütfen tekrar deneyin.";
$text['message-passkey_delete_failed']['zh-cn'] = "通行密钥删除失败，请重试。";
$text['message-passkey_delete_failed']['ja-jp'] = "パスキーの削除に失敗しました。もう一度お試しください。";
$text['message-passkey_delete_failed']['ko-kr'] = "패스키 삭제에 실패했습니다. 다시 시도해 주세요.";

$text['message-passkey_delete_confirm']['en-us'] = "Delete this passkey?";
$text['message-passkey_delete_confirm']['en-gb'] = "Delete this passkey?";
$text['message-passkey_delete_confirm']['ar-eg'] = "هل تريد حذف مفتاح المرور هذا؟";
$text['message-passkey_delete_confirm']['de-at'] = "Diesen Passkey löschen?";
$text['message-passkey_delete_confirm']['de-ch'] = "Diesen Passkey löschen?";
$text['message-passkey_delete_confirm']['de-de'] = "Diesen Passkey löschen?";
$text['message-passkey_delete_confirm']['el-gr'] = "Θέλετε να διαγράψετε αυτόν τον Passkey;";
$text['message-passkey_delete_confirm']['es-cl'] = "¿Eliminar esta clave de acceso?";
$text['message-passkey_delete_confirm']['es-mx'] = "¿Eliminar esta clave de acceso?";
$text['message-passkey_delete_confirm']['fr-ca'] = "Supprimer cette clé d'accès ?";
$text['message-passkey_delete_confirm']['fr-fr'] = "Supprimer cette clé d'accès ?";
$text['message-passkey_delete_confirm']['he-il'] = "למחוק את מפתח הגישה זה?";
$text['message-passkey_delete_confirm']['it-it'] = "Eliminare questo passkey?";
$text['message-passkey_delete_confirm']['ka-ge'] = "გსურთ ამ გასაღების წაშლა?";
$text['message-passkey_delete_confirm']['nl-nl'] = "Deze passkey verwijderen?";
$text['message-passkey_delete_confirm']['pl-pl'] = "Usunąć ten klucz dostępu?";
$text['message-passkey_delete_confirm']['pt-br'] = "Excluir esta chave de acesso?";
$text['message-passkey_delete_confirm']['pt-pt'] = "Eliminar esta chave de acesso?";
$text['message-passkey_delete_confirm']['ro-ro'] = "Ștergeți această cheie de acces?";
$text['message-passkey_delete_confirm']['ru-ru'] = "Удалить этот ключ доступа?";
$text['message-passkey_delete_confirm']['sv-se'] = "Vill du ta bort denna passkey?";
$text['message-passkey_delete_confirm']['uk-ua'] = "Видалити цей ключ доступу?";
$text['message-passkey_delete_confirm']['tr-tr'] = "Bu geçiş anahtarını silinsin mi?";
$text['message-passkey_delete_confirm']['zh-cn'] = "删除此通行密钥？";
$text['message-passkey_delete_confirm']['ja-jp'] = "このパスキーを削除しますか？";
$text['message-passkey_delete_confirm']['ko-kr'] = "이 패스키를 삭제하시겠습니까?";

$text['message-passkey_reset']['en-us'] = "Passkeys reset.";
$text['message-passkey_reset']['en-gb'] = "Passkeys reset.";
$text['message-passkey_reset']['ar-eg'] = "تمت إعادة تعيين مفاتيح المرور.";
$text['message-passkey_reset']['de-at'] = "Passkeys zurückgesetzt.";
$text['message-passkey_reset']['de-ch'] = "Passkeys zurückgesetzt.";
$text['message-passkey_reset']['de-de'] = "Passkeys zurückgesetzt.";
$text['message-passkey_reset']['el-gr'] = "Τα κλειδιά διαβάσματος επαναφέρθηκαν.";
$text['message-passkey_reset']['es-cl'] = "Claves de acceso restablecidas.";
$text['message-passkey_reset']['es-mx'] = "Claves de acceso restablecidas.";
$text['message-passkey_reset']['fr-ca'] = "Passkeys réinitialisés.";
$text['message-passkey_reset']['fr-fr'] = "Passkeys réinitialisés.";
$text['message-passkey_reset']['he-il'] = "מפתחי מעבר איפסו.";
$text['message-passkey_reset']['it-it'] = "Passkey reimpostati.";
$text['message-passkey_reset']['ka-ge'] = "გადასვლის სიკაბუთები განახლდა.";
$text['message-passkey_reset']['nl-nl'] = "Passkeys gereset.";
$text['message-passkey_reset']['pl-pl'] = "Klucze dostępu zresetowane.";
$text['message-passkey_reset']['pt-br'] = "Passkeys redefinidos.";
$text['message-passkey_reset']['pt-pt'] = "Passkeys repostos.";
$text['message-passkey_reset']['ro-ro'] = "Chei de acces resetate.";
$text['message-passkey_reset']['ru-ru'] = "Ключи доступа сброшены.";
$text['message-passkey_reset']['sv-se'] = "Passkeys återställda.";
$text['message-passkey_reset']['uk-ua'] = "Ключі доступу скинуті.";
$text['message-passkey_reset']['tr-tr'] = "Geçiş anahtarları sıfırlandı.";
$text['message-passkey_reset']['zh-cn'] = "通行密钥已重置。";
$text['message-passkey_reset']['ja-jp'] = "パスキーがリセットされました。";
$text['message-passkey_reset']['ko-kr'] = "패스키가 초기화되었습니다.";

$text['message-passkey_reset_confirm']['en-us'] = "Delete all passkeys for this user?";
$text['message-passkey_reset_confirm']['en-gb'] = "Delete all passkeys for this user?";
$text['message-passkey_reset_confirm']['ar-eg'] = "هل تريد حذف جميع مفاتيح المرور لهذا المستخدم؟";
$text['message-passkey_reset_confirm']['de-at'] = "Alle Passkeys für diesen Benutzer löschen?";
$text['message-passkey_reset_confirm']['de-ch'] = "Alle Passkeys für diesen Benutzer löschen?";
$text['message-passkey_reset_confirm']['de-de'] = "Alle Passkeys für diesen Benutzer löschen?";
$text['message-passkey_reset_confirm']['el-gr'] = "Να διαγραφούν όλα τα κλειδιά διέλευσης για αυτόν τον χρήστη;";
$text['message-passkey_reset_confirm']['es-cl'] = "¿Eliminar todas las passkeys de este usuario?";
$text['message-passkey_reset_confirm']['es-mx'] = "¿Eliminar todas las passkeys de este usuario?";
$text['message-passkey_reset_confirm']['fr-ca'] = "Supprimer toutes les passkeys de cet utilisateur ?";
$text['message-passkey_reset_confirm']['fr-fr'] = "Supprimer toutes les passkeys de cet utilisateur ?";
$text['message-passkey_reset_confirm']['he-il'] = "למחוק את כל מפתחות ההעברה למשתמש זה?";
$text['message-passkey_reset_confirm']['it-it'] = "Eliminare tutte le passkey per questo utente?";
$text['message-passkey_reset_confirm']['ka-ge'] = "უნდა წაიშალოს ამ მომხმარებლის ყველა passkey?";
$text['message-passkey_reset_confirm']['nl-nl'] = "Alle passkeys voor deze gebruiker verwijderen?";
$text['message-passkey_reset_confirm']['pl-pl'] = "Usunąć wszystkie passkey dla tego użytkownika?";
$text['message-passkey_reset_confirm']['pt-br'] = "Excluir todas as passkeys deste usuário?";
$text['message-passkey_reset_confirm']['pt-pt'] = "Eliminar todas as passkeys deste utilizador?";
$text['message-passkey_reset_confirm']['ro-ro'] = "Ștergeți toate passkey-urile pentru acest utilizator?";
$text['message-passkey_reset_confirm']['ru-ru'] = "Удалить все ключи доступа для этого пользователя?";
$text['message-passkey_reset_confirm']['sv-se'] = "Ta bort alla passkeys för denna användare?";
$text['message-passkey_reset_confirm']['uk-ua'] = "Видалити всі ключі доступу для цього користувача?";
$text['message-passkey_reset_confirm']['tr-tr'] = "Bu kullanıcı için tüm geçiş anahtarları silinsin mi?";
$text['message-passkey_reset_confirm']['zh-cn'] = "是否删除此用户的所有通行密钥？";
$text['message-passkey_reset_confirm']['ja-jp'] = "このユーザーのすべてのパスキーを削除しますか？";
$text['message-passkey_reset_confirm']['ko-kr'] = "이 사용자의 모든 패스키를 삭제하시겠습니까?";
