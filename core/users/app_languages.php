...
$text['description-user_totp_reset']['en-us'] = "Clear the TOTP secret so it can be reconfigured on next login.";
$text['description-user_totp_reset']['en-gb'] = "Clear the TOTP secret so it can be reconfigured on next login.";
$text['description-user_totp_reset']['ar-eg'] = "مسح سر TOTP حتى يمكن إعادة تكوينه في تسجيل الدخول التالي";
$text['description-user_totp_reset']['de-at'] = "Löschen Sie das TOTP-Geheimnis, damit es beim nächsten Login neu konfiguriert werden kann";
$text['description-user_totp_reset']['de-ch'] = "Löschen Sie das TOTP-Geheimnis, damit es beim nächsten Login neu konfiguriert werden kann";
$text['description-user_totp_reset']['de-de'] = "Löschen Sie das TOTP-Geheimnis, damit es beim nächsten Login neu konfiguriert werden kann";
$text['description-user_totp_reset']['el-gr'] = "Καθαρίστε το μυστικό TOTP ώστε να μπορεί να επαναδιαμορφωθεί στην επόμενη σύνδεση";
$text['description-user_totp_reset']['es-cl'] = "Borrar el secreto TOTP para que pueda ser reconfigurado en el próximo inicio de sesión";
$text['description-user_totp_reset']['es-mx'] = "Borrar el secreto TOTP para que pueda ser reconfigurado en el próximo inicio de sesión";
$text['description-user_totp_reset']['fr-ca'] = "Effacez le secret TOTP afin qu'il puisse être reconfiguré lors de la prochaine connexion";
$text['description-user_totp_reset']['fr-fr'] = "Effacez le secret TOTP afin qu'il puisse être reconfiguré lors de la prochaine connexion";
$text['description-user_totp_reset']['he-il'] = "נקה את סוד TOTP כך שניתן להגדיר אותו מחדש בהתחברות הבאה";
$text['description-user_totp_reset']['it-it'] = "Cancella il segreto TOTP in modo che possa essere riconfigurato al prossimo accesso";
$text['description-user_totp_reset']['ka-ge'] = "TOTP საიდუმლო გასუფტადეთ, რათა შემდეგი შესვლისას ხელახლა კონფიგურაცია შეძლოთ";
$text['description-user_totp_reset']['nl-nl'] = "Wis het TOTP geheim zodat het opnieuw geconfigureerd kan worden bij de volgende login";
$text['description-user_totp_reset']['pl-pl'] = "Wyczyść sekret TOTP, aby można go było ponownie skonfigurować przy następnym logowaniu";
$text['description-user_totp_reset']['pt-br'] = "Limpe o segredo TOTP para que ele possa ser reconfigurado no próximo login";
$text['description-user_totp_reset']['pt-pt'] = "Limpe o segredo TOTP para que ele possa ser reconfigurado no próximo login";
$text['description-user_totp_reset']['ro-ro'] = "Ștergeți secretul TOTP pentru a putea fi reconfigurat la următoarea autentificare";
$text['description-user_totp_reset']['ru-ru'] = "Очистите секрет TOTP, чтобы его можно было перенастроить при следующем входе в систему";
$text['description-user_totp_reset']['sv-se'] = "Rensa TOTP-hemligheten så att den kan konfigureras om vid nästa inloggning";
$text['description-user_totp_reset']['uk-ua'] = "Очистіть секрет TOTP, щоб його можна було перенастроить при следующем входе в систему";
$text['description-user_totp_reset']['tr-tr'] = "TOTP sırrını temizleyin, böylece bir sonraki girişte yeniden yapılandırılabilir";
$text['description-user_totp_reset']['zh-cn'] = "清除 TOTP 密钥，以便在下次登录时重新配置";
$text['description-user_totp_reset']['ja-jp'] = "TOTP シークレットをクリアして、次回のログインで再構成できるようにします。";
$text['description-user_totp_reset']['ko-kr'] = "TOTP 비밀을 지워 다음 로그인에서 다시 구성할 수 있도록 합니다。";
