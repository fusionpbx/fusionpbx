...
$text['title-database-edit']['zh-cn'] = "编辑数据库";
...
$text['title-database-add']['zh-cn'] = "添加数据库";
...
$text['header-database-edit']['zh-cn'] = "编辑数据库";
...
$text['header-database-add']['zh-cn'] = "添加数据库";
...
$text['description-path']['zh-cn'] = "Enter the database file path 输入数据库文件路径（仅限SQLite）。";
...
$text['description-host']['zh-cn'] = "输入主机IP或名称";
