...
//pre-populate the form
	if (is_uuid($_GET["id"]) && count($_GET) > 0 && $_POST["persistformvar"] != "true") {
		...
		$sql = "select user_setting_category, user_setting_subcategory, user_setting_name, user_setting_value, user_setting_order, ".($db_type=='pgsql'?"cast(user_setting_enabled as text)":"user_setting_enabled").", user_setting_description ";
