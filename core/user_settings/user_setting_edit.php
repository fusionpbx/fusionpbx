...
//show the content
	...
	else if ((substr_count($subcategory, "_color") > 0 || str_starts_with($user_setting_value ?? '', "rgb") || str_starts_with($user_setting_value ?? '', "#")) && ($user_setting_name == "text" || $user_setting_name == 'array')) {
