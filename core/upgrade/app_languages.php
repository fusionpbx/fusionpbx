...
$text['description-update_apps']['en-us'] = "Updates FusionPBX optional app source files from the respository.";
$text['description-update_apps']['en-gb'] = "Updates FusionPBX optional app source files from the respository.";
$text['description-update_apps']['ar-eg'] = "";
$text['description-update_apps']['de-at'] = "Aktualisiert den FusionPBX Quellcode aus dem Repository"; //copied from de-de
$text['description-update_apps']['de-ch'] = "Aktualisiert den FusionPBX Quellcode aus dem Repository"; //copied from de-de
$text['description-update_apps']['de-de'] = "Aktualisiert den FusionPBX Quellcode aus dem Repository";
$text['description-update_apps']['es-cl'] = "Archivos de origen Actualizaciones FusionPBX del repositorio.";
$text['description-update_apps']['es-mx'] = "Archivos de origen Actualizaciones FusionPBX del repositorio."; //copied from es-cl
$text['description-update_apps']['fr-ca'] = "Mise à jour du code source de FusionPBX depuis le dépôt."; //copied from fr-fr
$text['description-update_apps']['fr-fr'] = "Mise à jour du code source de FusionPBX depuis le dépôt.";
$text['description-update_apps']['he-il'] = "";
$text['description-update_apps']['it-it'] = "Aggiorna il files sorgente di FusionPBX dal repository.";
$text['description-update_apps']['nl-nl'] = "";
$text['description-update_apps']['pl-pl'] = "Uaktualnia pliki źródłowe FusionPBX z przechowalni.";
$text['description-update_apps']['pt-br'] = "Atualiza o FusionPBX a partir dos arquivos de código fonte do repositório.";
$text['description-update_apps']['pt-pt'] = "Arquivos de origem Atualizações FusionPBX do repositório.";
$text['description-update_apps']['ro-ro'] = "";
$text['description-update_apps']['ru-ru'] = "Обновляет исходные файлы FusionPBX из репозитория.";
$text['description-update_apps']['sv-se'] = "Uppdaterar FusionPBX källfiler från respository.";
$text['description-update_apps']['uk-ua'] = "Оновлення вихідних файлів  FusionPBX з репозиторію Subversion .";
