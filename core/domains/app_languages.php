...
$text['label-sub_domain']['en-us'] = "Sub Domain";
$text['label-sub_domain']['en-gb'] = "Sub Domain";
$text['label-sub_domain']['ar-eg'] = "النطاق الفرعي";
$text['label-sub_domain']['de-at'] = "Sub-Domain";
$text['label-sub_domain']['de-ch'] = "Sub-Domain";
$text['label-sub_domain']['de-de'] = "Sub-Domain";
$text['label-sub_domain']['el-gr'] = "Υποτομέας";
$text['label-sub_domain']['es-cl'] = "Subdominio";
$text['label-sub_domain']['es-mx'] = "Subdominio";
$text['label-sub_domain']['fr-ca'] = "Sous-domaine";
$text['label-sub_domain']['fr-fr'] = "Sous-domaine";
$text['label-sub_domain']['he-il'] = "תת-דומיין";
$text['label-sub_domain']['it-it'] = "Sottodominio";
$text['label-sub_domain']['ka-ge'] = "ქვედომენი";
$text['label-sub_domain']['nl-nl'] = "Subdomein";
$text['label-sub_domain']['pl-pl'] = "Subdomena";
$text['label-sub_domain']['pt-br'] = "Subdomínio";
$text['label-sub_domain']['pt-pt'] = "Subdomínio";
$text['label-sub_domain']['ro-ro'] = "Subdomeniu";
$text['label-sub_domain']['ru-ru'] = "Поддомен";
$text['label-sub_domain']['sv-se'] = "Subdomän";
$text['label-sub_domain']['uk-ua'] = "Піддомен";
$text['label-sub_domain']['tr-tr'] = "Alt Alan Adı";
$text['label-sub_domain']['zh-cn'] = "子域";
$text['label-sub_domain']['ja-jp'] = "サブドメイン";
$text['label-sub_domain']['ko-kr'] = "서브도메인";

$text['description-sub_domain']['en-us'] = "Enter only the sub-domain (prefix).";
$text['description-sub_domain']['en-gb'] = "Enter only the sub-domain (prefix).";
$text['description-sub_domain']['ar-eg'] = "أدخل فقط النطاق الفرعي (المقدمة).";
$text['description-sub_domain']['de-at'] = "Nur den Sub-Domain-Teil (Präfix) eingeben.";
$text['description-sub_domain']['de-ch'] = "Nur den Sub-Domain-Teil (Präfix) eingeben.";
$text['description-sub_domain']['de-de'] = "Nur den Sub-Domain-Teil (Präfix) eingeben.";
$text['description-sub_domain']['el-gr'] = "Εισαγάγετε μόνο τον υποτομέα (πρόθεμα).";
$text['description-sub_domain']['es-cl'] = "Ingrese solo el subdominio (prefijo).";
$text['description-sub_domain']['es-mx'] = "Ingrese solo el subdominio (prefijo).";
$text['description-sub_domain']['fr-ca'] = "Entrez uniquement le sous-domaine (préfixe).";
$text['description-sub_domain']['fr-fr'] = "Entrez uniquement le sous-domaine (préfixe).";
$text['description-sub_domain']['he-il'] = "הזן רק את תת-הדומיין (קידומת).";
$text['description-sub_domain']['it-it'] = "Inserisci solo il sottodominio (prefisso).";
$text['description-sub_domain']['ka-ge'] = "შეიყვანეთ მხოლოდ ქვედომენი (პრეფიქსი).";
$text['description-sub_domain']['nl-nl'] = "Voer alleen het subdomein (prefix) in.";
$text['description-sub_domain']['pl-pl'] = "Wpisz tylko subdomenę (prefiks).";
$text['description-sub_domain']['pt-br'] = "Informe apenas o subdomínio (prefixo).";
$text['description-sub_domain']['pt-pt'] = "Introduza apenas o subdomínio (prefixo).";
$text['description-sub_domain']['ro-ro'] = "Introduceți doar subdomeniul (prefix).";
$text['description-sub_domain']['ru-ru'] = "Введите только поддомен (префикс).";
$text['description-sub_domain']['sv-se'] = "Ange endast subdomänen (prefixet).";
$text['description-sub_domain']['uk-ua'] = "Введіть лише піддомен (префікс).";
$text['description-sub_domain']['tr-tr'] = "Yalnızca alt alan adını (ön ek) girin.";
$text['description-sub_domain']['zh-cn'] = "仅输入子域（前缀）。";
$text['description-sub_domain']['ja-jp'] = "サブドメイン（プレフィックス）のみを入力してください。";
$text['description-sub_domain']['ko-kr'] = "서브도메인(접두사)만 입력하십시오.";
