...
$text['description-domain_profile']['en-us'] = "Centralized management of domain wide settings, including the Time Zone, Language, and other domain settings.";
$text['description-domain_profile']['en-gb'] = "Centralized management of domain wide settings, including the Time Zone, Language, and other domain settings.";
$text['description-domain_profile']['ar-eg'] = "مركزية إدارة الإعدادات الواسعة النطاق، بما في ذلك منطقة الزمن، اللغة، والإعدادات الأخرى للنطاق.";
$text['description-domain_profile']['de-at'] = "Zentralisierte Verwaltung von domänenweiten Einstellungen, darunter Zeitzone, Sprache und andere Domäneneinstellungen.";
$text['description-domain_profile']['de-ch'] = "Zentralisierte Verwaltung von domänenweiten Einstellungen, darunter Zeitzone, Sprache und andere Domäneneinstellungen.";
$text['description-domain_profile']['de-de'] = "Zentralisierte Verwaltung von domänenweiten Einstellungen, darunter Zeitzone, Sprache und andere Domäneneinstellungen.";
$text['description-domain_profile']['el-gr'] = "Κεντρική διαχείριση ρυθμίσεων σε όλο το πεδίο, συμπεριλαμβανομένης της Ζώνης Ώρας, της Γλώσσας και άλλων ρυθμίσεων πεδίου.";
$text['description-domain_profile']['es-cl'] = "Gestión centralizada de configuraciones a nivel de dominio, incluyendo Zona Horaria, Idioma y otras configuraciones del dominio.";
$text['description-domain_profile']['es-mx'] = "Administración centralizada de configuraciones a nivel de dominio, incluyendo Zona Horaria, Idioma y otras configuraciones del dominio.";
$text['description-domain_profile']['fr-ca'] = "Gestion centralisée des paramètres de domaine, y compris la zone horaire, la langue et autres paramètres de domaine.";
$text['description-domain_profile']['fr-fr'] = "Gestion centralisée des paramètres de domaine, y compris la zone horaire, la langue et autres paramètres de domaine.";
$text['description-domain_profile']['he-il'] = "ניהול מרכזי של הגדרות רחבות הנחלה, כולל אזור זמן, שפה והגדרות נחלה אחרות.";
$text['description-domain_profile']['it-it'] = "Gestione centralizzata delle impostazioni a livello di dominio, inclusi Fuso Orario, Lingua e altre impostazioni di dominio.";
$text['description-domain_profile']['ka-ge'] = "დომენის მასშტაბით პარამეტრების ცენტრალიზებული მართვა, მათ შორის დროის ზონა, ენა და სხვა დომენის პარამეტრები.";
$text['description-domain_profile']['nl-nl'] = "Gecentraliseerd beheer van domeinbrede instellingen, waaronder tijdzone, taal en andere domeininstellingen.";
$text['description-domain_profile']['pl-pl'] = "Centralne zarządzanie ustawieniami domeny, w tym strefą czasową, językiem i innymi ustawieniami domeny.";
$text['description-domain_profile']['pt-br'] = "Gerenciamento centralizado de configurações do domínio, incluindo Fuso Horário, Idioma e outras configurações do domínio.";
$text['description-domain_profile']['pt-pt'] = "Gestão centralizada de configurações do domínio, incluindo Fuso Horário, Idioma e outras configurações do domínio.";
$text['description-domain_profile']['ro-ro'] = "Gestionare centralizată a setărilor la nivel de domeniu, inclusiv fusul orar, limba și alte setări ale domeniului.";
$text['description-domain_profile']['ru-ru'] = "Централизованное управление настройками домена, включая часовой пояс, язык и другие настройки домена.";
$text['description-domain_profile']['sv-se'] = "Centraliserad hantering av domänövergripande inställningar, inklusive tidszon, språk och andra domäninställningar.";
$text['description-domain_profile']['uk-ua'] = "Централізоване управління налаштуваннями домену, включаючи часову зону, мову та інші налаштування домену.";
$text['description-domain_profile']['tr-tr'] = "Alan genelinde zaman dilimi, dil ve diğer alan ayarları gibi alan genelinde ayarların merkezi yönetimi.";
$text['description-domain_profile']['zh-cn'] = "域级别设置的集中管理，包括时区、语言和其他域设置。";
$text['description-domain_profile']['ja-jp'] = "ドメイン全体の設定の集中管理、タイムゾーン、言語、およびその他のドメイン設定を含む。";
$text['description-domain_profile']['ko-kr'] = "도메인 전체 설정의 중앙 관리, 시간대, 언어 및 기타 도메인 설정 포함.";
