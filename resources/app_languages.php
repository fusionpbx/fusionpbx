...
$text['label-ringback']['es-mx'] = "Volver a llamar"; //copied from es-cl
$text['label-ringback']['fr-ca'] = "Rappeler"; //copied from fr-fr
...
$text['description-description']['pt-pt'] = "Insira a descrição, caso desejar"; //copied from pt-br
