...
class parsedown {
	 ...
	 * @param array|null $Block An optional block of text, expected to be null or an array with 'type' and optionally 'interrupted' keys
	 *
	 ...
	 * @param array $Block The block being processed, with an 'interrupted' key indicating whether it has been interrupted
	 *
	 ...
	 *
	 * @return array|null An array representing the inserted inline image, or null if the excerpt does not contain a valid link to insert as an image
	 */
	 ...
	 *
	 * @return array|null A result object containing the extent of processing and the element, or null if no link was found
	 */
	 ...
	 *
	 * @return array|null An object with 'extent' and 'element' properties if strikethrough formatting is applied, otherwise null
	 */
	 ...
	 *
	 * If an array of linked URLs is set, and the excerpt's text is not empty at index 2 (i.e. it starts with 'http://') or the context already contains a full URL,
	 * this method creates an inline element (an anchor tag) that links to the extracted URL.
	 *
	 ...
	 *
	 * @param array $Element An associative array describing the element to render, including its attributes and content.
	 *
