					...
					if (@sizeof($results) == 1) {
						...
						if ($result['username'] != '') {
							...
							//generate reset link email and body variables
								...
								$reset_url = (strlen($_SESSION['login']['reset_url']['text']) > 0) ? $_SESSION['login']['reset_url']['text'] : $domain_name;
								$key = encrypt($_SESSION['login']['password_reset_key']['text'], $result['username'].'|'.$result['domain_uuid'].'|'.$result['password']);
								$reset_link = "https://".$reset_url.PROJECT_PATH."/login.php?action=define&key=".urlencode($key);
							...
							//replace variables in email body
								...
								$email_body = str_replace('${domain}', $reset_url, $email_body);
