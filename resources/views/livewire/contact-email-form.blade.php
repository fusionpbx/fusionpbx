            ...
            @foreach ($emails as $index => $email)
                <div class="row mb-2">
                    <div class="col-md-6">
                        ...
                        <input type="email" wire:model="emails.{{ $index }}.email_address" class="form-control"
                            placeholder="Email">
                    </div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-12 mb-3">
                        <label for="email_description_{{ $index }}" class="form-label">Description</label>
                        <textarea id="email_description_{{ $index }}" wire:model="emails.{{ $index }}.email_description" class="form-control @error('email_description') is-invalid @enderror"
                            rows="3"></textarea>
                    </div>
                </div>
                <div class="col-md-2">
