...
--------------------------------------
[FusionPBX](http://fusionpbx.com/) is a flexible, customizable web interface that uses [FreeSWITCH](http://freeswitch.org) as a single or multi-tenant PBX system or a flexible communication platform.
